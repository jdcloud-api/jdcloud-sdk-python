...
class ListOfflineAnalysisRequest(JDCloudRequest):
    """
    查询redis离线分析任务列表
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(ListOfflineAnalysisRequest, self).__init__(
            '/regions/{regionId}/cacheInstance/{cacheInstanceId}/listOfflineAnalysis', 'GET', header, version)
        self.parameters = parameters


class ListOfflineAnalysisParameters(object):
