...
class DescribeAdminPublicModelsRequest(JDCloudRequest):
    """
    管理端查询公共模型列表
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(DescribeAdminPublicModelsRequest, self).__init__(
            '/model-regions/{regionId}/adminPublicModel', 'GET', header, version)
        self.parameters = parameters


class DescribeAdminPublicModelsParameters(object):
