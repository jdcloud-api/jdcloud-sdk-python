...
class SetOriginAuthenticationRequest(JDCloudRequest):
    """
    设置回源鉴权信息
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(SetOriginAuthenticationRequest, self).__init__(
            '/liveDomain/{domain}/originAuthentication', 'POST', header, version)
        self.parameters = parameters


class SetOriginAuthenticationParameters(object):
