...
class CreateFunctionReq(object):

    def __init__(self, companyCode=None, workspaceCode=None, functionName=None, functionCatalogId=None, className=None, managers=None, resourceCodes=None, functionFormat=None, functionUsage=None, relativeEngine=None):
        """
