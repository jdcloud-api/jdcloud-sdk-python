...
class GravityParticleDubboJobManagerDeployJobEditRequest(JDCloudRequest):
    """
    编辑作业信息
    """

    def __init__(self, parameters, header=None, version="v2"):
        super(GravityParticleDubboJobManagerDeployJobEditRequest, self).__init__(
            '/regions/{regionId}/apps/{appName}/gravityParticleDubboJobManagerDeployJobEdit', 'POST', header, version)
        self.parameters = parameters


class GravityParticleDubboJobManagerDeployJobEditParameters(object):
