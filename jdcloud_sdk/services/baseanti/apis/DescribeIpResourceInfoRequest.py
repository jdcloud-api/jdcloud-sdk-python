...
class DescribeIpResourceInfoRequest(JDCloudRequest):
    """
    ...
    def __init__(self, parameters, header=None, version="v1"):
        super(DescribeIpResourceInfoRequest, self).__init__(
            '/regions/{regionId}/ipResources/{ip}', 'GET', header, version)
        self.parameters = parameters


class DescribeIpResourceInfoParameters(object):
