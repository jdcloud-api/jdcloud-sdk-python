...
class ApplyElasticIpsRequest(JDCloudRequest):
    """
    申请弹性公网IP
    ...
    def __init__(self, parameters, header=None, version="v1"):
        super(ApplyElasticIpsRequest, self).__init__(
            '/regions/{regionId}/elasticIps', 'PUT', header, version)
        self.parameters = parameters


class ApplyElasticIpsParameters(object):
