...
class DataWorkShopGetRunningResourceRequest(JDCloudRequest):
    """
    获取正在使用的资源组
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(DataWorkShopGetRunningResourceRequest, self).__init__(
            '/regions/{regionId}/apps/{appName}/dataWorkShopGetRunningResource', 'POST', header, version)
        self.parameters = parameters


class DataWorkShopGetRunningResourceParameters(object):
