...
class UserAddRoleRequest(JDCloudRequest):
    """
    
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(UserAddRoleRequest, self).__init__(
            '/regions/{regionId}/apps/{appName}/userAddRole', 'POST', header, version)
        self.parameters = parameters


class UserAddRoleParameters(object):
