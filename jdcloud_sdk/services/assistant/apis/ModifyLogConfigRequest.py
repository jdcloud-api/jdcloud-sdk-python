...
class ModifyLogConfigRequest(JDCloudRequest):
    """
...
- 该接口用于配置用户日志信息。
    ...
    def __init__(self, parameters, header=None, version="v1"):
        super(ModifyLogConfigRequest, self).__init__(
            '/regions/{regionId}/modifyLogConfig', 'POST', header, version)
        self.parameters = parameters


class ModifyLogConfigParameters(object):
