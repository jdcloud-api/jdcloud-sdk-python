...
class OrderReq(object):
    ...
    def __init__(self, region, buyType, timeSpan, timeUnit, startTime, packageType, extraDomainsNum, returnURL, extraBitsLimit, wafInstanceId=None, nickName=None, extraPackage=None, appCode=None, serviceCode=None, buyScenario=None, needPay=None):
        """
