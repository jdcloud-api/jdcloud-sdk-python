...
class ModifyNetDiskRequest(JDCloudRequest):
    """
    修改网盘，当前仅支持开通网盘
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(ModifyNetDiskRequest, self).__init__(
            '/regions/{regionId}/modifyNetDisk', 'POST', header, version)
        self.parameters = parameters


class ModifyNetDiskParameters(object):
