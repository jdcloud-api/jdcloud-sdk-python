...
class NetworkInterfaceSpec(object):
    ...
    def __init__(self, subnetId, az=None, networkInterfaceName=None, primaryIpAddress=None, secondaryIpAddresses=None, secondaryIpCount=None, secondaryIpMaskLen=None, description=None):
        """
        :param subnetId:  子网ID
