...
class Ipv6PublicSpec(object):

    def __init__(self, subnetId, az=None, networkInterfaceName=None, primaryIpAddress=None, secondaryIpAddresses=None, secondaryIpCount=None, securityGroups=None, sanityCheck=None, description=None, ipv6Addresses=None, userTags=None, resourceGroupId=None):
        """
        :param subnetId:  子网ID
