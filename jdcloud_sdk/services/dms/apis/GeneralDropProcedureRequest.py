...
class GeneralDropProcedureRequest(JDCloudRequest):
    """
    生成删除存储过程sql语句，支持Mysql
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(GeneralDropProcedureRequest, self).__init__(
            '/regions/{regionId}/procedure:generalDrop', 'POST', header, version)
        self.parameters = parameters


class GeneralDropProcedureParameters(object):
