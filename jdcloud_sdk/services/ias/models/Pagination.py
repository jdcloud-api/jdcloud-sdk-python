...
class Pagination(object):
    ...
    def __init__(self, currPageNo=None, numberPages=None, numberRecords=None, pageSize=None, startIndex=None):
        """
        :param currPageNo: (Optional) currPageNo
        :param numberPages: (Optional) numberPages
        :param numberRecords: (Optional) numberRecords
        :param pageSize: (Optional) pageSize
        :param startIndex: (Optional) startIndex
        """
