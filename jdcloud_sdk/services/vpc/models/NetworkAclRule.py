...
class NetworkAclRule(object):
    ...
    def __init__(self, ruleId=None, protocol=None, fromPort=None, toPort=None, direction=None, addressPrefixType=None, addressPrefix=None, ruleAction=None, priority=None, description=None, createdTime=None, ruleType=None):
        """
