...
class HistorySqlRequest(JDCloudRequest):
    """
    获取当前实例用户查询sql历史
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(HistorySqlRequest, self).__init__(
            '/regions/{regionId}/historySql', 'POST', header, version)
        self.parameters = parameters


class HistorySqlParameters(object):
