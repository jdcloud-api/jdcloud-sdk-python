...
class ModifyVpcRequest(JDCloudRequest):
    """
    修改私有网络接口
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(ModifyVpcRequest, self).__init__(
            '/regions/{regionId}/vpcs/{vpcId}', 'PATCH', header, version)
        self.parameters = parameters


class ModifyVpcParameters(object):
