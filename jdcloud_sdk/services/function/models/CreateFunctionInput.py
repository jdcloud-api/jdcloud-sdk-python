...
class CreateFunctionInput(object):

    def __init__(self, name=None, description=None, entrance=None, memory=None, runTime=None, overTime=None, version=None, code=None, environment=None, logSetId=None, logTopicId=None, vpcId=None, subnetId=None):
        """
