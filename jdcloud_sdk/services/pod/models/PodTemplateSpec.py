...
class PodTemplateSpec(object):
    ...
    def __init__(self, instanceType, containers, primaryNetworkInterface, restartPolicy=None, terminationGracePeriodSeconds=None, dnsConfig=None, logConfig=None, hostAliases=None, volumes=None, elasticIp=None, secondaryNetworkInterfaces=None, userTags=None):
        """
