...
class UpdateImageStyleRequest(JDCloudRequest):
    """
    修改图片样式
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(UpdateImageStyleRequest, self).__init__(
            '/regions/{regionId}/buckets/{bucketName}/imageStyles/{id}', 'PUT', header, version)
        self.parameters = parameters


class UpdateImageStyleParameters(object):
