...
class WarningCfg(object):
    ...
    def __init__(self, id=None, userPin=None, warnType=None, enable=None, detectSpan=None, detectThreshold=None, contactWays=None, contactorPersons=None, contactorGroups=None):
        """
