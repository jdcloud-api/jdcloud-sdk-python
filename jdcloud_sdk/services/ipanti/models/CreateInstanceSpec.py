...
class CreateInstanceSpec(object):
    ...
    def __init__(self, buyType, carrier, ipCount, portCount, bp, ep, bw, id=None, name=None, ipType=None, domainCount=None, timeSpan=None, timeUnit=None, returnUrl=None):
        """
        ...
        :param ipCount:  IP 数量
        :param portCount:  可配的转发端口数量
        :param domainCount: (Optional) 可配的网站规则域名数量
        :param bp:  保底带宽: 单位 Gbps
        :param ep:  弹性带宽: 单位 Gbps
        :param bw:  业务带宽: 单位 Mbps
        :param timeSpan: (Optional) 购买防护包时长, 新购高防实例时必传<br>- timeUnit 为 3 时, 可取值 1-9<br>- timeUnit 为 4 时, 可取值 1-3
