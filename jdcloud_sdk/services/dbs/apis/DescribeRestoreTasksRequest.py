...
class DescribeRestoreTasksRequest(JDCloudRequest):
    """
    查询当前备份计划下最近1年的恢复任务，按创建任务时间倒序排列
    """

    def __init__(self, parameters, header=None, version="v2"):
        super(DescribeRestoreTasksRequest, self).__init__(
            '/regions/{regionId}/backupPlans/{backupPlanId}:describeRestoreTasks', 'GET', header, version)
        self.parameters = parameters


class DescribeRestoreTasksParameters(object):
