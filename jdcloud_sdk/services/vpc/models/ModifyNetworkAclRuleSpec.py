...
class ModifyNetworkAclRuleSpec(object):

    def __init__(self, ruleId, protocol=None, fromPort=None, toPort=None, addressPrefixType=None, addressPrefix=None, ruleAction=None, priority=None, description=None):
        """
        :param ruleId:  networkAcl规则ID
        ...
        :param addressPrefix: (Optional) addressPrefix不允许重复, 匹配地址前缀, 源/目的IP. addressPrefixType为CIDR时，传IP地址或网段，如：10.0.0.0/24; addressPrefixType为PREFIXLIST时，传前缀列表ID，如：pl-bkh3jumsqk
