...
class CreateVmInstancesRequest(JDCloudRequest):
    """
...
- 密码
    ...
    def __init__(self, parameters, header=None, version="v2"):
        super(CreateVmInstancesRequest, self).__init__(
            '/regions/{regionId}/ydVmInstances', 'POST', header, version)
        self.parameters = parameters


class CreateVmInstancesParameters(object):
