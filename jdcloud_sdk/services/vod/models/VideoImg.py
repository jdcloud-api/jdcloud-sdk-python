...
class VideoImg(object):

    def __init__(self, mid=None, videoName=None, url=None, imgUrl=None, categoryId=None, category=None, status=None, size=None, duration=None, createTime=None, updateTime=None, tags=None, notes=None, imgList=None):
        """
