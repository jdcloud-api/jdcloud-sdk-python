...
class GravityParticleDubboJobManagerVerifyScriptFileRequest(JDCloudRequest):
    """
    脚本校验
    """

    def __init__(self, parameters, header=None, version="v2"):
        super(GravityParticleDubboJobManagerVerifyScriptFileRequest, self).__init__(
            '/regions/{regionId}/apps/{appName}/gravityParticleDubboJobManagerVerifyScriptFile', 'POST', header, version)
        self.parameters = parameters


class GravityParticleDubboJobManagerVerifyScriptFileParameters(object):
