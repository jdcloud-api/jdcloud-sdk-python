...
class UranusScriptSyntaxCheckRequest(JDCloudRequest):
    """
    sql语法检测
    """

    def __init__(self, parameters, header=None, version="v2"):
        super(UranusScriptSyntaxCheckRequest, self).__init__(
            '/regions/{regionId}/apps/{appName}/uranusScriptSyntaxCheck', 'POST', header, version)
        self.parameters = parameters


class UranusScriptSyntaxCheckParameters(object):
