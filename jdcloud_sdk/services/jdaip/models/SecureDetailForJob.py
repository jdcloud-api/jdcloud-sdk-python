...
class SecureDetailForJob(object):

    def __init__(self, id=None, sourcePath=None, mountPath=None):
        """
        :param id: (Optional) 安全存储 ID。示例：fs-11******us。
        :param sourcePath: (Optional) 安全存储源路径。可选值：/data、/output。
        :param mountPath: (Optional) 挂载点配置。示例：/mnt/secure-1。
