...
class GetEngineDetailsByWorkspaceCodeRequest(JDCloudRequest):
    """
    通过空间code查询绑定的计算引擎信息及对应类型和JCW/JMR实例信息
    """

    def __init__(self, parameters, header=None, version="v2"):
        super(GetEngineDetailsByWorkspaceCodeRequest, self).__init__(
            '/regions/{regionId}/apps/{appName}/getEngineDetailsByWorkspaceCode', 'POST', header, version)
        self.parameters = parameters


class GetEngineDetailsByWorkspaceCodeParameters(object):
