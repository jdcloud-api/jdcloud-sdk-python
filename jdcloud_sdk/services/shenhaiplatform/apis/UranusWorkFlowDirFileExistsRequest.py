...
class UranusWorkFlowDirFileExistsRequest(JDCloudRequest):
    """
    校验文件是否存在
    """

    def __init__(self, parameters, header=None, version="v2"):
        super(UranusWorkFlowDirFileExistsRequest, self).__init__(
            '/regions/{regionId}/apps/{appName}/uranusWorkFlowDirFileExists', 'POST', header, version)
        self.parameters = parameters


class UranusWorkFlowDirFileExistsParameters(object):
