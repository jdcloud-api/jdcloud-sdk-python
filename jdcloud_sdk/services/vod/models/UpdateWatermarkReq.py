...
class UpdateWatermarkReq(object):

    def __init__(self, id=None, name=None, imgUrl=None, width=None, height=None, position=None, unit=None, offsetX=None, offsetY=None):
        """
