...
class ModifyInvoiceTemplateRequest(JDCloudRequest):
    """
    修改发票模版
    """

    def __init__(self, parameters, header=None, version="v2"):
        super(ModifyInvoiceTemplateRequest, self).__init__(
            '/regions/{regionId}/invoiceTemplate', 'PUT', header, version)
        self.parameters = parameters


class ModifyInvoiceTemplateParameters(object):
