...
class AsAlarmInfo(object):

    def __init__(self, agId=None, asAlarmId=None, region=None, name=None, description=None, metricType=None, metricName=None, namespace=None, period=None, statistic=None, threshold=None, comparison=None, hitCount=None, asRules=None, createTime=None, updateTime=None, state=None):
        """
...
- 自定义监控取值范围：[`avg`]
        ...
        :param asRules: (Optional) 关联的伸缩规则列表
