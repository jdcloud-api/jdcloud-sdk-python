...
class StartCodeInterpreterSessionRequest(JDCloudRequest):
    """
    创建 codeInterpreter session
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(StartCodeInterpreterSessionRequest, self).__init__(
            '/regions/{regionId}/codeinterpreters/{codeInterpreterId}/sessions', 'POST', header, version)
        self.parameters = parameters


class StartCodeInterpreterSessionParameters(object):
