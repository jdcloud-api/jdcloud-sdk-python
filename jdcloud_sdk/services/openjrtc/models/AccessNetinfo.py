...
class AccessNetinfo(object):

    def __init__(self, appId=None, userRoomId=None, userId=None, nickName=None, connectId=None, networkType=None, extranetIp=None, location=None, netScore=None, status=None, joinTime=None, updateTime=None):
        """
