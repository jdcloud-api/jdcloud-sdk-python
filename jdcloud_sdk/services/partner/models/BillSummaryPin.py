...
class BillSummaryPin(object):

    def __init__(self, pin=None, loginName=None, customerName=None, billFee=None, discountFee=None, eraseFee=None, actualFee=None, payCouponFee=None, freeCouponFee=None, cashPayFee=None, balancePayFee=None):
        """
