...
class SetForwardAuthenticationRequest(JDCloudRequest):
    """
    设置转推鉴权信息
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(SetForwardAuthenticationRequest, self).__init__(
            '/liveDomain/{domain}/forwardAuthentication', 'POST', header, version)
        self.parameters = parameters


class SetForwardAuthenticationParameters(object):
