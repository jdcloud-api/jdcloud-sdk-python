...
class VolumeMount(object):
    ...
    def __init__(self, category=None, autoDelete=None, mountPath=None, readOnly=None, cloudDisk=None, localDisk=None, fsType=None):
        """
        :param category: (Optional) 磁盘分类
        ...
        :param localDisk: (Optional) 云硬盘规格
