...
class WorkspaceGetUcUserByPinRequest(JDCloudRequest):
    """
    根据用户pin查询uc用户信息
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(WorkspaceGetUcUserByPinRequest, self).__init__(
            '/regions/{regionId}/apps/{appName}/workspaceGetUcUserByPin', 'POST', header, version)
        self.parameters = parameters


class WorkspaceGetUcUserByPinParameters(object):
