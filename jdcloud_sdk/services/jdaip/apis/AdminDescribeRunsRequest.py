...
class AdminDescribeRunsRequest(JDCloudRequest):
    """
...
- `state`：运行状态，精确匹配，支持多个
    ...
    def __init__(self, parameters, header=None, version="v1"):
        super(AdminDescribeRunsRequest, self).__init__(
            '/train/{regionId}/api/{apiType}/runs', 'GET', header, version)
        self.parameters = parameters


class AdminDescribeRunsParameters(object):
