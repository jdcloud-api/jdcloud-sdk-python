...
class FunctionInfoRequest(JDCloudRequest):
    """
    获取函数详情，支持Mysql
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(FunctionInfoRequest, self).__init__(
            '/regions/{regionId}/function:info', 'POST', header, version)
        self.parameters = parameters


class FunctionInfoParameters(object):
