...
class SubnetDesInfo(object):

    def __init__(self, id=None, name=None, vpcId=None, cidrBlock=None, description=None, az=None, createdTime=None, cloudID=None):
        """
