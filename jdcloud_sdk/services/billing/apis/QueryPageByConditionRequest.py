...
class QueryPageByConditionRequest(JDCloudRequest):
    """
    查询资源单列表
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(QueryPageByConditionRequest, self).__init__(
            '/regions/{regionId}/queryPageByCondition', 'POST', header, version)
        self.parameters = parameters


class QueryPageByConditionParameters(object):
