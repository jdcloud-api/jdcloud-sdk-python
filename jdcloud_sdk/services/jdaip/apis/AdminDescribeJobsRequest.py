...
class AdminDescribeJobsRequest(JDCloudRequest):
    """
...
- `ownerUser`：所有者名称，模糊匹配
    ...
    def __init__(self, parameters, header=None, version="v1"):
        super(AdminDescribeJobsRequest, self).__init__(
            '/train/{regionId}/api/{apiType}/jobs', 'GET', header, version)
        self.parameters = parameters


class AdminDescribeJobsParameters(object):
