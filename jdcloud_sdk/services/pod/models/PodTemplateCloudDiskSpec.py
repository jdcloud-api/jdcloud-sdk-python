...
class PodTemplateCloudDiskSpec(object):

    def __init__(self, snapshotId=None, diskType=None, sizeGB=None, fsType=None, iops=None, autoDelete=None):
        """
        :param snapshotId: (Optional) 云盘快照id，根据云盘快照创建云盘。（仅数据盘支持）
