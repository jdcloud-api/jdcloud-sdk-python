...
class WorkspaceAddMemberRequest(JDCloudRequest):
    """
    添加工作空间成员
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(WorkspaceAddMemberRequest, self).__init__(
            '/regions/{regionId}/apps/{appName}/workspaceAddMember', 'POST', header, version)
        self.parameters = parameters


class WorkspaceAddMemberParameters(object):
