...
class UranusTaskFlowListTreeRequest(JDCloudRequest):
    """
    工作流目录树
    """

    def __init__(self, parameters, header=None, version="v2"):
        super(UranusTaskFlowListTreeRequest, self).__init__(
            '/regions/{regionId}/apps/{appName}/uranusTaskFlowListTree', 'POST', header, version)
        self.parameters = parameters


class UranusTaskFlowListTreeParameters(object):
