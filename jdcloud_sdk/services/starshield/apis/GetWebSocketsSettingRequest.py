...
class GetWebSocketsSettingRequest(JDCloudRequest):
    """
...
这使得在WebSockets连接中的数据交换非常快。WebSockets经常被用于实时应用，如即时聊天和游戏。
    ...
    def __init__(self, parameters, header=None, version="v1"):
        super(GetWebSocketsSettingRequest, self).__init__(
            '/zones/{zone_identifier}/settings$$websockets', 'GET', header, version)
