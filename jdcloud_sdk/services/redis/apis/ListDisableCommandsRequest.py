...
class ListDisableCommandsRequest(JDCloudRequest):
    """
    获取支持被禁用的命令列表
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(ListDisableCommandsRequest, self).__init__(
            '/regions/{regionId}/cacheInstance/{cacheInstanceId}/listDisableCommands', 'GET', header, version)
        self.parameters = parameters


class ListDisableCommandsParameters(object):
