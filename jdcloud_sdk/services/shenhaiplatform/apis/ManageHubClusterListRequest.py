...
class ManageHubClusterListRequest(JDCloudRequest):
    """
    检索集群列表
    """

    def __init__(self, parameters, header=None, version="v2"):
        super(ManageHubClusterListRequest, self).__init__(
            '/regions/{regionId}/apps/{appName}/manageHubClusterList', 'POST', header, version)
        self.parameters = parameters


class ManageHubClusterListParameters(object):
