...
class ModifyPublicAddressRequest(JDCloudRequest):
    """
    修改实例公网访问配置
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(ModifyPublicAddressRequest, self).__init__(
            '/regions/{regionId}/cacheInstance/{cacheInstanceId}/modifyPublicAddress', 'POST', header, version)
        self.parameters = parameters


class ModifyPublicAddressParameters(object):
    ...
    def setAction(self, action):
        """
        :param action: (Optional) allocate(开启公网) release(关闭公网) change(换绑公网)
        """
        self.action = action
