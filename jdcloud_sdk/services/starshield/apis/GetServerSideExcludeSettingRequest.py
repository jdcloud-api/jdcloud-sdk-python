...
class GetServerSideExcludeSettingRequest(JDCloudRequest):
    """
...
在这种情况下，SSE 仍将发挥作用，因为星盾的 HTML 缩减和 SSE 功能是在资源通过我们的网络传输给我们时即时发生的。当资源通过我们的网络移动到访问者的计算机上时，SSE 仍会发挥作用。
    ...
    def __init__(self, parameters, header=None, version="v1"):
        super(GetServerSideExcludeSettingRequest, self).__init__(
            '/zones/{zone_identifier}/settings$$server_side_exclude', 'GET', header, version)
