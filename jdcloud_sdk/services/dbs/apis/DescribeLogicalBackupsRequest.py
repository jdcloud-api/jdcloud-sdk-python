...
class DescribeLogicalBackupsRequest(JDCloudRequest):
    """
    查询所有的逻辑备份结果
    """

    def __init__(self, parameters, header=None, version="v2"):
        super(DescribeLogicalBackupsRequest, self).__init__(
            '/regions/{regionId}/backupPlans/{backupPlanId}:describeLogicalBackups', 'GET', header, version)
        self.parameters = parameters


class DescribeLogicalBackupsParameters(object):
