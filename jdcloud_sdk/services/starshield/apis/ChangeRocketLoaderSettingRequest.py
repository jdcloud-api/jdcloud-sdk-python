...
class ChangeRocketLoaderSettingRequest(JDCloudRequest):
    """
...
当打开时，Rocket Loader将自动推迟加载你的HTML中引用的所有Javascript，而不需要配置。
    ...
    def __init__(self, parameters, header=None, version="v1"):
        super(ChangeRocketLoaderSettingRequest, self).__init__(
            '/zones/{zone_identifier}/settings$$rocket_loader', 'PATCH', header, version)
