...
class ModifyTranscodeTemplateRequest(JDCloudRequest):
    """
    部分修改转码模板
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(ModifyTranscodeTemplateRequest, self).__init__(
            '/transcodeTemplates/{templateId}', 'PATCH', header, version)
        self.parameters = parameters


class ModifyTranscodeTemplateParameters(object):
