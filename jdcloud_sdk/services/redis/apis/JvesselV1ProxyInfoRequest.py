...
class JvesselV1ProxyInfoRequest(JDCloudRequest):
    """
    获取京舰V1 proxy信息
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(JvesselV1ProxyInfoRequest, self).__init__(
            '/regions/{regionId}/cacheInstance/{cacheInstanceId}/jvesselV1ProxyInfo', 'GET', header, version)
        self.parameters = parameters


class JvesselV1ProxyInfoParameters(object):
