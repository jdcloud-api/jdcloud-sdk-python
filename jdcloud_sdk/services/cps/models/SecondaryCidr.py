...
class SecondaryCidr(object):
    ...
    def __init__(self, secondaryCidrId=None, cidr=None, region=None, az=None, subnetId=None, name=None, vpcId=None, vpcName=None, vpcCidr=None, availableIpCount=None, totalIpCount=None):
        """
        ...
        :param vpcCidr: (Optional) 私有网络cidr
