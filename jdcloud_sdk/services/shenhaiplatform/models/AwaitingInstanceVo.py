...
class AwaitingInstanceVo(object):

    def __init__(self, jobName=None, companyCode=None, workspaceCode=None, instanceId=None, jobType=None, txDate=None, createTime=None):
        """
