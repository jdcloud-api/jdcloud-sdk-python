...
class DescribeDownloadUrlRequest(JDCloudRequest):
    ...
    def __init__(self, parameters, header=None, version="v1"):
        super(DescribeDownloadUrlRequest, self).__init__(
            '/regions/{regionId}/cacheInstance/{cacheInstanceId}/backup:describeDownloadUrl', 'GET', header, version)
        self.parameters = parameters


class DescribeDownloadUrlParameters(object):
