...
class DescribeAsAlarmsRequest(JDCloudRequest):
    """
    查看告警任务
...
- 伸缩功能开启或者关闭的情况下，都支持调用此接口
    ...
    def __init__(self, parameters, header=None, version="v1"):
        super(DescribeAsAlarmsRequest, self).__init__(
            '/regions/{regionId}/asAlarms', 'GET', header, version)
        self.parameters = parameters


class DescribeAsAlarmsParameters(object):
