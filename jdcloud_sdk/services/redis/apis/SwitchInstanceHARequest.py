...
class SwitchInstanceHARequest(JDCloudRequest):
    """
    修改集群高可用分布
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(SwitchInstanceHARequest, self).__init__(
            '/regions/{regionId}/cacheInstance/{cacheInstanceId}/switchInstanceHA', 'POST', header, version)
        self.parameters = parameters


class SwitchInstanceHAParameters(object):
    ...
    def setSwitchList(self, switchList):
        """
        :param switchList: (Optional) 切换列表
        """
