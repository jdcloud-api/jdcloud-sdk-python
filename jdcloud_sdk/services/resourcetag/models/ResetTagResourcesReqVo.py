...
class ResetTagResourcesReqVo(object):

    def __init__(self, serviceCodes, resourceTags, ):
        """
        :param serviceCodes:  产品线名称列表, 目前仅支持对同一个serviceCode下的资源进行批量标签替换
标签系统支持的产品线名称如下
...
- nativecontainer  pod         zfs        jqs         kubernetesNodegroup   jcq
        ...
        :param resourceTags:  由资源id和替换后的标签构成的数组
        """
