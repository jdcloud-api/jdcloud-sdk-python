...
class ModifyElasticIpBandwidthRequest(JDCloudRequest):
    """
    修改弹性公网IP带宽
    ...
    def __init__(self, parameters, header=None, version="v1"):
        super(ModifyElasticIpBandwidthRequest, self).__init__(
            '/regions/{regionId}/elasticIps/{elasticIpId}:modifyElasticIpBandwidth', 'PUT', header, version)
