...
class ContainerSpec(object):
    ...
    def __init__(self, instanceType, az, name, rootVolume, primaryNetworkInterface, hostAliases=None, hostname=None, command=None, args=None, envs=None, image=None, secret=None, tty=None, workingDir=None, dataVolumes=None, elasticIp=None, logConfiguration=None, description=None, charge=None, userTags=None, resourceGroupId=None, imageCacheId=None, autoMatchImageCache=None, autoCreateImageCache=None):
        """
        ...
        :param image: (Optional) 镜像名称 </br> 1. Docker Hub官方镜像通过类似nginx, mysql/mysql-server的名字指定 </br> </br> repository长度最大256个字符，tag最大128个字符，registry最大255个字符
