...
class DescribeDomainQueryCountRequest(JDCloudRequest):
    """
    查看主域名的解析次数
    """

    def __init__(self, parameters, header=None, version="v2"):
        super(DescribeDomainQueryCountRequest, self).__init__(
            '/regions/{regionId}/domain/{domainId}/queryCount', 'GET', header, version)
        self.parameters = parameters


class DescribeDomainQueryCountParameters(object):
