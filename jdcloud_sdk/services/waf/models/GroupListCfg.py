...
class GroupListCfg(object):

    def __init__(self, id=None, ruleName=None, updateTime=None, disable=None, groupMatchItems=None, atCfg=None, skipRuleId=None):
        """
        ...
        :param groupMatchItems: (Optional) group配置
