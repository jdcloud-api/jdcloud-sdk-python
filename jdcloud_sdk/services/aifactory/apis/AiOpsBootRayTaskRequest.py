...
class AiOpsBootRayTaskRequest(JDCloudRequest):
    """
    执行 Ray 任务
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(AiOpsBootRayTaskRequest, self).__init__(
            '/regions/{regionId}/apps/{appName}/aiOpsBootRayTask', 'POST', header, version)
        self.parameters = parameters


class AiOpsBootRayTaskParameters(object):
