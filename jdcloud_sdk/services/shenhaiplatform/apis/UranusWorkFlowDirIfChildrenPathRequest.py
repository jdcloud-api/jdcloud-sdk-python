...
class UranusWorkFlowDirIfChildrenPathRequest(JDCloudRequest):
    """
    判断是否有子目录
    """

    def __init__(self, parameters, header=None, version="v2"):
        super(UranusWorkFlowDirIfChildrenPathRequest, self).__init__(
            '/regions/{regionId}/apps/{appName}/uranusWorkFlowDirIfChildrenPath', 'POST', header, version)
        self.parameters = parameters


class UranusWorkFlowDirIfChildrenPathParameters(object):
