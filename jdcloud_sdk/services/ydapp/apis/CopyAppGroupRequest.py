...
class CopyAppGroupRequest(JDCloudRequest):
    """
    复制指定分组
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(CopyAppGroupRequest, self).__init__(
            '/app/{appId}/group/{groupId}:copy', 'POST', header, version)
        self.parameters = parameters


class CopyAppGroupParameters(object):

    def __init__(self,appId, groupId, groupKey, env, clusterId, podCount, cpu, memory, requestCpu, requestMemory, ):
        """
        :param appId: 应用ID
        :param groupId: 源分组ID
        ...
        self.deployStrategyStruct = None
    ...
    def setImageUrl(self, imageUrl):
        """
        :param imageUrl: (Optional) 镜像地址，固定值：imageUrlHolder
        """
    ...
    def setDeployStrategyStruct(self, deployStrategyStruct):
        """
