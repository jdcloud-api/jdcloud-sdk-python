...
class WorkspaceVerifyUserIsManagerRequest(JDCloudRequest):
    """
    校验当前用户是否是该工作空间的管理员
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(WorkspaceVerifyUserIsManagerRequest, self).__init__(
            '/regions/{regionId}/apps/{appName}/workspaceVerifyUserIsManager', 'POST', header, version)
        self.parameters = parameters


class WorkspaceVerifyUserIsManagerParameters(object):
