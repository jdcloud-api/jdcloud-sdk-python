...
class CreateAccountWithoutPrivilegeRequest(JDCloudRequest):
    """
    创建数据库的未授权的账号
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(CreateAccountWithoutPrivilegeRequest, self).__init__(
            '/regions/{regionId}/instances/{instanceId}/accounts:createAccountWithoutPrivilege', 'POST', header, version)
        self.parameters = parameters


class CreateAccountWithoutPrivilegeParameters(object):
