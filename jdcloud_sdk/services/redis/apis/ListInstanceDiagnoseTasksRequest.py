...
class ListInstanceDiagnoseTasksRequest(JDCloudRequest):
    """
    查询指定实例的诊断任务列表，支持时间范围过滤和分页
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(ListInstanceDiagnoseTasksRequest, self).__init__(
            '/regions/{regionId}/cacheInstance/{cacheInstanceId}/listInstanceDiagnoses', 'GET', header, version)
        self.parameters = parameters


class ListInstanceDiagnoseTasksParameters(object):
