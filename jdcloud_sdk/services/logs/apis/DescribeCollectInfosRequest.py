...
class DescribeCollectInfosRequest(JDCloudRequest):
    """
    采集配置列表信息。
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(DescribeCollectInfosRequest, self).__init__(
            '/regions/{regionId}/logtopics/{logtopicUID}/collectinfos', 'GET', header, version)
        self.parameters = parameters


class DescribeCollectInfosParameters(object):
