...
class DescribeRouteTableRulesRequest(JDCloudRequest):
    """
    查询路由表 rule 列表
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(DescribeRouteTableRulesRequest, self).__init__(
            '/regions/{regionId}/routeTables/{routeTableId}/routeTableRules', 'GET', header, version)
        self.parameters = parameters


class DescribeRouteTableRulesParameters(object):
