...
class NetworkInterfaceSpec(object):
    ...
    def __init__(self, subnetId, az=None, networkInterfaceName=None, primaryIpAddress=None, secondaryIpAddresses=None, secondaryIpCount=None, securityGroups=None, sanityCheck=None, description=None, ipv6AddressCount=None, ipv6Address=None):
        """
        :param subnetId:  子网ID
        ...
        :param ipv6AddressCount: (Optional) 自动分配的ipv6地址数量
        :param ipv6Address: (Optional) 指定分配的ipv6地址，不能与ipv6AddressCount同时指定
        """
