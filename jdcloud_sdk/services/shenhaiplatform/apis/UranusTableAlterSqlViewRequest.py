...
class UranusTableAlterSqlViewRequest(JDCloudRequest):
    """
    发布，保存发布，更新发布等等
    """

    def __init__(self, parameters, header=None, version="v2"):
        super(UranusTableAlterSqlViewRequest, self).__init__(
            '/regions/{regionId}/apps/{appName}/uranusTableAlterSqlView', 'POST', header, version)
        self.parameters = parameters


class UranusTableAlterSqlViewParameters(object):
