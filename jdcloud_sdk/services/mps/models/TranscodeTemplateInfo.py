...
class TranscodeTemplateInfo(object):

    def __init__(self, templateId=None, title=None, video=None, audio=None, container=None, encryption=None, definition=None, transcodeType=None, createTime=None, updateTime=None):
        """
