...
class DescribeAnalysisTimeRequest(JDCloudRequest):
    """
    获取自动缓存分析时间
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(DescribeAnalysisTimeRequest, self).__init__(
            '/regions/{regionId}/cacheInstance/{cacheInstanceId}/analysisTime', 'GET', header, version)
        self.parameters = parameters


class DescribeAnalysisTimeParameters(object):
