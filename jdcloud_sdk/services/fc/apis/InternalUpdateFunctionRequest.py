...
class InternalUpdateFunctionRequest(JDCloudRequest):
    """
    修改 function
    ...
    def __init__(self, parameters, header=None, version="v1"):
        super(InternalUpdateFunctionRequest, self).__init__(
            '/regions/{regionId}/services/{serviceName}/functions/{functionName}:internal', 'PATCH', header, version)
        self.parameters = parameters


class InternalUpdateFunctionParameters(object):
