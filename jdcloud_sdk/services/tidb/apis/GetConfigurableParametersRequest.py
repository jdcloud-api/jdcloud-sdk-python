...
class GetConfigurableParametersRequest(JDCloudRequest):
    """
    获取所有可配置参数（筛选）
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(GetConfigurableParametersRequest, self).__init__(
            '/regions/{regionId}/parameters', 'GET', header, version)
        self.parameters = parameters


class GetConfigurableParametersParameters(object):
