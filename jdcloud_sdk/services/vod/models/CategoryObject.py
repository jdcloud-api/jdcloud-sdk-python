...
class CategoryObject(object):
    ...
    def __init__(self, id=None, name=None, level=None, parentId=None, description=None, createTime=None, updateTime=None):
        """
        :param id: (Optional) 分类ID
        :param name: (Optional) 分类名称
        :param level: (Optional) 分类级别。取值范围为 [0, 3]，取值为 0 时为虚拟根节点
