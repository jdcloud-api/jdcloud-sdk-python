...
class DescribeCustomLiveStreamWatermarkTemplatesRequest(JDCloudRequest):
    ...
    def __init__(self, parameters, header=None, version="v1"):
        super(DescribeCustomLiveStreamWatermarkTemplatesRequest, self).__init__(
            '/watermarkCustoms', 'GET', header, version)
        self.parameters = parameters


class DescribeCustomLiveStreamWatermarkTemplatesParameters(object):
