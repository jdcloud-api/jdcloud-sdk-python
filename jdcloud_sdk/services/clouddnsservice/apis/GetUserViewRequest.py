...
class GetUserViewRequest(JDCloudRequest):
    ...
    def __init__(self, parameters, header=None, version="v1"):
        super(GetUserViewRequest, self).__init__(
            '/regions/{regionId}/userview/getUserView', 'GET', header, version)
        self.parameters = parameters


class GetUserViewParameters(object):
    ...
    def __init__(self, regionId, domainId, viewId, pageNumber, pageSize):
        ...
        :param pageNumber: 分页参数，页的序号
        :param pageSize: 分页参数，每页含有的结果的数目
        """
