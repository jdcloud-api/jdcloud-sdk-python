...
class RouteTableRule(object):
    ...
    def __init__(self, ruleId=None, priority=None, nextHopType=None, nextHopId=None, addressPrefix=None):
        """
        ...
        :param nextHopType: (Optional) 下一跳类型, 取值范围:local:本地, instance:云主机, internet:公网, vpc_peering:vpc对等连接, bgw:边界网关
