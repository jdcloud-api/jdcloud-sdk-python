...
class DescribeFlowLogsRequest(JDCloudRequest):
    """
    本接口用于查询流日志资源列表
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(DescribeFlowLogsRequest, self).__init__(
            '/regions/{regionId}/flowLogs', 'GET', header, version)
        self.parameters = parameters


class DescribeFlowLogsParameters(object):
    ...
    def setFilters(self, filters):
        """
        :param filters: (Optional) 	flowLogStatus - 流日志状态，支持单个
