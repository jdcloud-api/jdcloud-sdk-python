...
class ListModulesRequest(JDCloudRequest):
    """
    获取module列表
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(ListModulesRequest, self).__init__(
            '/regions/{regionId}/cacheInstance/{cacheInstanceId}/modules', 'GET', header, version)
        self.parameters = parameters


class ListModulesParameters(object):
