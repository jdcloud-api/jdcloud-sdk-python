...
class UpdateUserRoleRequest(JDCloudRequest):
    """
    修改用户角色
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(UpdateUserRoleRequest, self).__init__(
            '/regions/{regionId}/apps/{appName}/updateUserRole', 'POST', header, version)
        self.parameters = parameters


class UpdateUserRoleParameters(object):
    ...
    def setRoleList(self, roleList):
        """
        :param roleList: (Optional) 角色列表
        """
        self.roleList = roleList

    def setRoleCodeList(self, roleCodeList):
        """
        :param roleCodeList: (Optional) 角色Code列表，逗号隔开
        """
