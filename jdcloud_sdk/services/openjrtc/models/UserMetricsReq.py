...
class UserMetricsReq(object):

    def __init__(self, startTime=None, endTime=None, interval=None, userRoomId=None, userId=None, metricType=None, metricNames=None):
        """
        ...
        :param userId: (Optional) 业务接入方定义的且在JRTC系统内注册过userId
