...
class WorkspaceVerifyAuthRequest(JDCloudRequest):
    """
    判断用户pin和工作空间code校验是否有工作空间权限
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(WorkspaceVerifyAuthRequest, self).__init__(
            '/regions/{regionId}/apps/{appName}/workspaceVerifyAuth', 'POST', header, version)
        self.parameters = parameters


class WorkspaceVerifyAuthParameters(object):
