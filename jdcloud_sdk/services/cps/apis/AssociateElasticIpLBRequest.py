...
class AssociateElasticIpLBRequest(JDCloudRequest):
    """
    绑定弹性公网IP
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(AssociateElasticIpLBRequest, self).__init__(
            '/regions/{regionId}/slbs/{loadBalancerId}:associateElasticIp', 'PUT', header, version)
        self.parameters = parameters


class AssociateElasticIpLBParameters(object):
