...
class AddCoProductRequest(JDCloudRequest):
    """
    添加合作产品
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(AddCoProductRequest, self).__init__(
            '/regions/{regionId}/CooperationInfo:addCoProduct', 'POST', header, version)
        self.parameters = parameters


class AddCoProductParameters(object):
