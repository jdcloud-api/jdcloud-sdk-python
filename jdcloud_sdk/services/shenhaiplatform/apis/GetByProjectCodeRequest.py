...
class GetByProjectCodeRequest(JDCloudRequest):
    """
    按照projectCode查询绑定的计算引擎信息以及计算引擎绑定的空间信息
    """

    def __init__(self, parameters, header=None, version="v2"):
        super(GetByProjectCodeRequest, self).__init__(
            '/regions/{regionId}/apps/{appName}/getByProjectCode', 'POST', header, version)
        self.parameters = parameters


class GetByProjectCodeParameters(object):
