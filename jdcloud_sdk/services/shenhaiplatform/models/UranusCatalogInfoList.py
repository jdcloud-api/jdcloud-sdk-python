...
class UranusCatalogInfoList(object):

    def __init__(self, catalogCode, unrealId=None, catalogName=None, catalogType=None, parentCode=None, childrenNum=None, taskFlowList=None):
        """
        ...
        :param taskFlowList: (Optional) 流程列表
        """
        ...
        self.taskFlowList = taskFlowList
