...
class DescribeAlarmsCmRequest(JDCloudRequest):
    """
    查询自定义监控规则
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(DescribeAlarmsCmRequest, self).__init__(
            '/regions/{regionId}/cm/alarms', 'GET', header, version)
        self.parameters = parameters


class DescribeAlarmsCmParameters(object):
