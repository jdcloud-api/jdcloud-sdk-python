...
class VideoResultDetail(object):

    def __init__(self, scene=None, label=None, score=None, suggestion=None, sfaceData=None):
        """
        ...
        :param sfaceData: (Optional) 视频中包含暴恐识涉政内容时，返回识别出来的暴恐涉政信息，具体结构描述见sfaceData
        """
