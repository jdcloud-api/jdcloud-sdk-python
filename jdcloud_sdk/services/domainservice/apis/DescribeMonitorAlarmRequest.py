...
class DescribeMonitorAlarmRequest(JDCloudRequest):
    """
    主域名的监控项的报警信息
    """

    def __init__(self, parameters, header=None, version="v2"):
        super(DescribeMonitorAlarmRequest, self).__init__(
            '/regions/{regionId}/domain/{domainId}/monitorAlarm', 'GET', header, version)
        self.parameters = parameters


class DescribeMonitorAlarmParameters(object):
