...
class GetCronJobListRequest(JDCloudRequest):
    """
    获取执行计划列表
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(GetCronJobListRequest, self).__init__(
            '/regions/{regionId}/cronJob:list', 'POST', header, version)
        self.parameters = parameters


class GetCronJobListParameters(object):
