...
class DescribeInstanceTLSRequest(JDCloudRequest):
    """
    查询tls配置
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(DescribeInstanceTLSRequest, self).__init__(
            '/regions/{regionId}/cacheInstance/{cacheInstanceId}/tls', 'GET', header, version)
        self.parameters = parameters


class DescribeInstanceTLSParameters(object):
