...
class JvesselV1HealthRequest(JDCloudRequest):
    """
    京舰V1实例健康状态
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(JvesselV1HealthRequest, self).__init__(
            '/regions/{regionId}/cacheInstance/{cacheInstanceId}/jvesselV1Health', 'GET', header, version)
        self.parameters = parameters


class JvesselV1HealthParameters(object):
