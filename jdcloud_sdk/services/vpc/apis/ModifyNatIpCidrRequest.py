...
class ModifyNatIpCidrRequest(JDCloudRequest):
    """
    修改NAT IP地址段接口
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(ModifyNatIpCidrRequest, self).__init__(
            '/regions/{regionId}/natGateways/{natGatewayId}/natIpCidrs', 'PATCH', header, version)
        self.parameters = parameters


class ModifyNatIpCidrParameters(object):

    def __init__(self,regionId, natGatewayId, natIpCidrId, ):
        """
        :param regionId: Region ID
        :param natGatewayId: natGateway ID
        :param natIpCidrId: NAT IP 地址段 ID；注意：默认地址段不允许修改
        """
