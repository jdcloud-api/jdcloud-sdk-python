...
class UpdateCollectInfoSpec(object):
    ...
    def __init__(self, enabled, resourceType, agResource=None, binlogSpec=None, filterEnabled=None, k8sSpec=None, logFile=None, logFilters=None, logPath=None, logtopicEnabled=None, name=None, regexpStr=None, resourceMode=None, resources=None, tagResource=None):
        """
