...
class WorkspaceGetProjectRequest(JDCloudRequest):
    """
    获取工作空间绑定的云仓项目
    """

    def __init__(self, parameters, header=None, version="v2"):
        super(WorkspaceGetProjectRequest, self).__init__(
            '/regions/{regionId}/apps/{appName}/workspaceGetProject', 'POST', header, version)
        self.parameters = parameters


class WorkspaceGetProjectParameters(object):
