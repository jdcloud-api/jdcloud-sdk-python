...
class GetPipelinesRequest(JDCloudRequest):
    """
...
/v1/regions/cn-south-1?sorts.1.name=startedAt&sorts.1.direction=desc&pageNumber=1&pageSize=10&filters.1.name=name&filters.1.values.1=我的pipeline
    ...
    def __init__(self, parameters, header=None, version="v1"):
        super(GetPipelinesRequest, self).__init__(
            '/regions/{regionId}/pipeline', 'GET', header, version)
        self.parameters = parameters


class GetPipelinesParameters(object):
