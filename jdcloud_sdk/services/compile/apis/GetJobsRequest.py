...
class GetJobsRequest(JDCloudRequest):
    """
...
/v2/regions/cn-south-1/jobs/?sorts.1.name=status&sorts.1.direction=asc&pageNumber=1&pageSize=10&filters.1.name=name&filters.1.values.1=我的job
    ...
    def __init__(self, parameters, header=None, version="v1"):
        super(GetJobsRequest, self).__init__(
            '/regions/{regionId}/jobs', 'GET', header, version)
        self.parameters = parameters


class GetJobsParameters(object):
