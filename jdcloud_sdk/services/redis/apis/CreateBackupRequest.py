...
class CreateBackupRequest(JDCloudRequest):
    ...
    def __init__(self, parameters, header=None, version="v1"):
        super(CreateBackupRequest, self).__init__(
            '/regions/{regionId}/cacheInstance/{cacheInstanceId}/backup', 'POST', header, version)
...
class CreateBackupParameters(object):
    ...
    def __init__(self, regionId, cacheInstanceId, fileName, backupType):
        ...
        :param fileName: 备份文件名称，只支持英文数字和下划线的组合，长度不超过32个字符
        :param backupType: 备份类型：手动备份为1，只能为手动备份
        """
