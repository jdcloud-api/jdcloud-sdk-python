...
class GeneralAlterTriggerRequest(JDCloudRequest):
    """
    生成修改触发器sql语句，支持Mysql
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(GeneralAlterTriggerRequest, self).__init__(
            '/regions/{regionId}/trigger:generalAlter', 'POST', header, version)
        self.parameters = parameters


class GeneralAlterTriggerParameters(object):
    ...
    def setOriginTriggerName(self, originTriggerName):
        """
        :param originTriggerName: (Optional) 原触发器名称。
        """
        self.originTriggerName = originTriggerName
