...
class ResourceAeVo(object):
    ...
    def __init__(self, id=None, site=None, appCode=None, region=None, serviceCode=None, formula=None, pin=None, resourceId=None, billingType=None, subBillId=None, state=None, stateTime=None, op=None, isLastRecord=None, createTime=None, updateTime=None, toDeleteTime=None, capState=None):
        ...
        :param state: (Optional) 状态 0:无 1:正常 2:欠费, 3:因欠费而停机, 4:欠费删除资源, 6:已删除但已不欠费, 7:欠费延期，8:删除并且欠费，9:欠费删除数据，12:已过期, 13:因过期而停机, 14:过期删除资源、退款删除, 17:过期延期 19:过期删除数据23:管理员停服，24:管理员删除,34:用户删除
        :param stateTime: (Optional) 首次欠费时间（各欠费状态）或过期时间（各过期状态）
        :param op: (Optional) 变成此状态的原因.0:无 1:账单欠费, 2:资源过期 ,3:加入、移出白名单 ,4:补扣款成功, 5:规则修改,6:续费 7:管理员操作,8:用户操作,9:加入/移出回收站,11:账号注销删除
        ...
        :param capState: (Optional) 用于中间层判断的状态标识 1:正常(重启) 3:欠费停服 4:欠费删除 13：到期停服 14：到期删除、退款删除 24：运营删除 34:用户删除 45:账号注销删除
        """
