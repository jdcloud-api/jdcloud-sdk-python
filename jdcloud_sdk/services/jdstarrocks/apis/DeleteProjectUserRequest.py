...
class DeleteProjectUserRequest(JDCloudRequest):
    """
    删除项目用户列表
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(DeleteProjectUserRequest, self).__init__(
            '/regions/{regionId}/apps/{appName}/deleteProjectUser', 'POST', header, version)
        self.parameters = parameters


class DeleteProjectUserParameters(object):
