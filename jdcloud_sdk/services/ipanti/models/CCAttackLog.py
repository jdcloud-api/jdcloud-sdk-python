...
class CCAttackLog(object):

    def __init__(self, attackId=None, attackTraffic=None, blackHole=None, startTime=None, endTime=None, unit=None, instanceId=None, name=None):
        """
