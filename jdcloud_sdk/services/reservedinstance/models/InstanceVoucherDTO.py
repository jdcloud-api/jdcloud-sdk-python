...
class InstanceVoucherDTO(object):

    def __init__(self, instanceVoucherId=None, reservedInstanceType=None, pin=None, serviceCode=None, isReserved=None, status=None, startTime=None, endTime=None):
        """
