...
class Output(object):
    ...
    def __init__(self, region=None, bucket=None, objectPath=None):
        """
        :param region: (Optional) 输出对象存储区域
        :param bucket: (Optional) 输出对象存储空间
        :param objectPath: (Optional) 截图输出路径，包含占位符的截图输出路径。当前支持的占位符包括：
