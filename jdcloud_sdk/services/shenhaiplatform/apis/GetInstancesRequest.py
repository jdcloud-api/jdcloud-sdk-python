...
class GetInstancesRequest(JDCloudRequest):
    """
    通过计算引擎Code查询绑定的云仓和JMR实例列表
    """

    def __init__(self, parameters, header=None, version="v2"):
        super(GetInstancesRequest, self).__init__(
            '/regions/{regionId}/apps/{appName}/getInstances', 'POST', header, version)
        self.parameters = parameters


class GetInstancesParameters(object):
