...
class UpdateTranscodeTemplateRequestInfo(object):

    def __init__(self, title=None, video=None, audio=None, container=None, encryption=None, definition=None, transcodeType=None):
        """
