...
class DescribeDetailNodeListRequest(JDCloudRequest):
    """
    获取缓存Redis实例的节点列表，可分页、可搜索
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(DescribeDetailNodeListRequest, self).__init__(
            '/regions/{regionId}/cacheInstance/{cacheInstanceId}/detailNode', 'GET', header, version)
        self.parameters = parameters


class DescribeDetailNodeListParameters(object):
