...
class DescribeClusterInfoRequest(JDCloudRequest):
    """
    查询Redis实例的集群内部信息
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(DescribeClusterInfoRequest, self).__init__(
            '/regions/{regionId}/cacheInstance/{cacheInstanceId}/clusterInfo', 'GET', header, version)
