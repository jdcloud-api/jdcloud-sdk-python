...
class UpdateProductUpdateSpec(object):

    def __init__(self, title=None, content=None, updateType=None, publishDate=None, displayOrder=None, isSticky=None, tags=None):
        """
        ...
        :param tags: (Optional) null不更新，否则全量更新（空数组更新为无）
        """
