...
class AiOpsListRayTaskInstancePodsRequest(JDCloudRequest):
    """
    Ray 任务实例 Pod 列表查询
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(AiOpsListRayTaskInstancePodsRequest, self).__init__(
            '/regions/{regionId}/apps/{appName}/aiOpsListRayTaskInstancePods', 'POST', header, version)
        self.parameters = parameters


class AiOpsListRayTaskInstancePodsParameters(object):
