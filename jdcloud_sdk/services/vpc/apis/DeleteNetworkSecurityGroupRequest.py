...
class DeleteNetworkSecurityGroupRequest(JDCloudRequest):
    """
    删除安全组
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(DeleteNetworkSecurityGroupRequest, self).__init__(
            '/regions/{regionId}/networkSecurityGroups/{networkSecurityGroupId}', 'DELETE', header, version)
