...
class DescribeAnalyseListRequest(JDCloudRequest):
    """
    获取当前实例的所有诊断记录
    """

    def __init__(self, parameters, header=None, version="v2"):
        super(DescribeAnalyseListRequest, self).__init__(
            '/regions/{regionId}/instance/{instanceGid}/analyseList', 'GET', header, version)
        self.parameters = parameters


class DescribeAnalyseListParameters(object):
    ...
    def setState(self, state):
        """
        :param state: (Optional) 是否只过滤死锁存在的记录
        """
        self.state = state
