...
class RunningInstanceVo(object):

    def __init__(self, jobName=None, companyCode=None, workspaceCode=None, instanceId=None, applicationId=None, jobType=None, txDate=None, status=None, createTime=None):
        """
