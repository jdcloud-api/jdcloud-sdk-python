...
class UpdateProductWithAdminRequest(JDCloudRequest):
    """
    修改产品
    """

    def __init__(self, parameters, header=None, version="v2"):
        super(UpdateProductWithAdminRequest, self).__init__(
            '/regions/{regionId}/loongrayinstances/{instanceId}/products/{productKey}/admin', 'PATCH', header, version)
        self.parameters = parameters


class UpdateProductWithAdminParameters(object):
