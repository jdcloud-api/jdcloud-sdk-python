...
class QueryResourceReqVo(object):

    def __init__(self, serviceCode, tagFilters=None, operator=None):
        """
        :param serviceCode:  产品线名称列表
标签系统支持的产品线名称如下
...
- nativecontainer  pod         zfs        jqs         kubernetesNodegroup   jcq
        ...
        :param operator: (Optional) 操作项(多个tagFilter之间支持and或or关系, 默认and关系)
        """
