...
class AiOpsStopRayTaskInstanceRequest(JDCloudRequest):
    """
    停止 Ray 任务实例
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(AiOpsStopRayTaskInstanceRequest, self).__init__(
            '/regions/{regionId}/apps/{appName}/aiOpsStopRayTaskInstance', 'POST', header, version)
        self.parameters = parameters


class AiOpsStopRayTaskInstanceParameters(object):
