...
class DataWorkShopGetAllResourcesRequest(JDCloudRequest):
    """
    获取当前租户下的所有资源列表
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(DataWorkShopGetAllResourcesRequest, self).__init__(
            '/regions/{regionId}/apps/{appName}/dataWorkShopGetAllResources', 'POST', header, version)
        self.parameters = parameters


class DataWorkShopGetAllResourcesParameters(object):
