...
class K8sDispatchConfRequest(JDCloudRequest):
    """
    k8s日志采集配置下发
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(K8sDispatchConfRequest, self).__init__(
            '/k8sconfig', 'POST', header, version)
        self.parameters = parameters


class K8sDispatchConfParameters(object):
