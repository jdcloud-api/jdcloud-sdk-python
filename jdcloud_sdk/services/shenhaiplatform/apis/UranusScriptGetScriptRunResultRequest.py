...
class UranusScriptGetScriptRunResultRequest(JDCloudRequest):
    """
    获取运行脚本结果
    """

    def __init__(self, parameters, header=None, version="v2"):
        super(UranusScriptGetScriptRunResultRequest, self).__init__(
            '/regions/{regionId}/apps/{appName}/uranusScriptGetScriptRunResult', 'POST', header, version)
        self.parameters = parameters


class UranusScriptGetScriptRunResultParameters(object):
