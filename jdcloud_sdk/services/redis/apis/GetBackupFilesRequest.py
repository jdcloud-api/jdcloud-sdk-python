...
class GetBackupFilesRequest(JDCloudRequest):
    """
    查询历史备份文件
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(GetBackupFilesRequest, self).__init__(
            '/regions/{regionId}/cacheInstance/{cacheInstanceId}/getBackupFiles', 'GET', header, version)
        self.parameters = parameters


class GetBackupFilesParameters(object):
