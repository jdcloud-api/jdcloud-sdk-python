...
class QuerySplitItemMonthSummaryRequest(JDCloudRequest):
    """
    查询分账账单月汇总数据
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(QuerySplitItemMonthSummaryRequest, self).__init__(
            '/regions/{regionId}/splitItemBillMonthSummary:List', 'POST', header, version)
        self.parameters = parameters


class QuerySplitItemMonthSummaryParameters(object):
    ...
    def setSubIds(self, subIds):
        """
        :param subIds: (Optional) 拆分项ID列表,最多支持传入500个
        """
        self.subIds = subIds
