...
class AiOpsGetRayTaskInstancePodDetailRequest(JDCloudRequest):
    """
    Ray 任务实例 Pod 详情
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(AiOpsGetRayTaskInstancePodDetailRequest, self).__init__(
            '/regions/{regionId}/apps/{appName}/aiOpsGetRayTaskInstancePodDetail', 'POST', header, version)
        self.parameters = parameters


class AiOpsGetRayTaskInstancePodDetailParameters(object):
