...
class EnableWebRuleCCRequest(JDCloudRequest):
    """
    ...
    def __init__(self, parameters, header=None, version="v1"):
        super(EnableWebRuleCCRequest, self).__init__(
            '/regions/{regionId}/instances/{instanceId}/webRules/{webRuleId}:enableCC', 'POST', header, version)
        self.parameters = parameters


class EnableWebRuleCCParameters(object):
