...
class UserDeleteRoleRequest(JDCloudRequest):
    """
    
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(UserDeleteRoleRequest, self).__init__(
            '/regions/{regionId}/apps/{appName}/userDeleteRole', 'POST', header, version)
        self.parameters = parameters


class UserDeleteRoleParameters(object):
