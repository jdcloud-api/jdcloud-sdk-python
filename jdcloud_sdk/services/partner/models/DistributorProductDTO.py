...
class DistributorProductDTO(object):

    def __init__(self, id=None, distributorId=None, distributorName=None, distributorPin=None, productType=None, productId=None, productName=None, status=None, remark=None, createTime=None, createUser=None, updateTime=None, updateUser=None, yn=None):
        """
