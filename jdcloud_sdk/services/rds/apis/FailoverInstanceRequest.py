...
class FailoverInstanceRequest(JDCloudRequest):
    ...
    def __init__(self, parameters, header=None, version="v1"):
        super(FailoverInstanceRequest, self).__init__(
            '/regions/{regionId}/instances/{instanceId}:failoverInstance', 'POST', header, version)
        self.parameters = parameters


class FailoverInstanceParameters(object):
