...
class RemoveBandwidthPackageIpRequest(JDCloudRequest):
    ...
    def __init__(self, parameters, header=None, version="v1"):
        super(RemoveBandwidthPackageIpRequest, self).__init__(
            '/regions/{regionId}/bandwidthPackages/{bandwidthPackageId}:removeBandwidthPackageIp', 'PUT', header, version)
        self.parameters = parameters


class RemoveBandwidthPackageIpParameters(object):

    def __init__(self, regionId, bandwidthPackageId, elasticIpId):
        """
