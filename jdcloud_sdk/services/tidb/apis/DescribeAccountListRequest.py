...
class DescribeAccountListRequest(JDCloudRequest):
    """
    查看某个TiDB实例下所有账号信息，包括账号名称、对各个数据库的访问权限信息等
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(DescribeAccountListRequest, self).__init__(
            '/regions/{regionId}/instances/{instanceId}/accountsList', 'GET', header, version)
        self.parameters = parameters


class DescribeAccountListParameters(object):
