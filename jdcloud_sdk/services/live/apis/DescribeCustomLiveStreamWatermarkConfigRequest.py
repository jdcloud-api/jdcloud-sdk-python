...
class DescribeCustomLiveStreamWatermarkConfigRequest(JDCloudRequest):
    """
    查询直播水印配置
...
- 该查询旨在查询域名、应用、流最终生效的水印模板配置,并非各级的模板绑定情况
    ...
    def __init__(self, parameters, header=None, version="v1"):
        super(DescribeCustomLiveStreamWatermarkConfigRequest, self).__init__(
            '/watermarks:config', 'GET', header, version)
        self.parameters = parameters


class DescribeCustomLiveStreamWatermarkConfigParameters(object):
