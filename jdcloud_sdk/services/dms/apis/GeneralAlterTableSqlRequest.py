...
class GeneralAlterTableSqlRequest(JDCloudRequest):
    """
    生成修改表结构语句sql，支持Mysql，Stardb
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(GeneralAlterTableSqlRequest, self).__init__(
            '/regions/{regionId}/alterSql:general', 'POST', header, version)
        self.parameters = parameters


class GeneralAlterTableSqlParameters(object):
