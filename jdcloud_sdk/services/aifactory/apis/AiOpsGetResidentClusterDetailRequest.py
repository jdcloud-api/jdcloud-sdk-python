...
class AiOpsGetResidentClusterDetailRequest(JDCloudRequest):
    """
    常驻集群详情
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(AiOpsGetResidentClusterDetailRequest, self).__init__(
            '/regions/{regionId}/apps/{appName}/aiOpsGetResidentClusterDetail', 'POST', header, version)
        self.parameters = parameters


class AiOpsGetResidentClusterDetailParameters(object):
