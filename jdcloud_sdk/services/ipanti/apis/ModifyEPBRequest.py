...
class ModifyEPBRequest(JDCloudRequest):
    """
    更新实例弹性防护带宽
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(ModifyEPBRequest, self).__init__(
            '/regions/{regionId}/instances/{instanceId}:modifyEPB', 'POST', header, version)
...
class ModifyEPBParameters(object):
    ...
    def __init__(self, regionId,instanceId,modifyInstanceEPBSpec):
        ...
        :param modifyInstanceEPBSpec: 修改实例名称请求参数
        """
