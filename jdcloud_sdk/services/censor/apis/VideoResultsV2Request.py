...
class VideoResultsV2Request(JDCloudRequest):
    """
    根据taskid查询视频检测结果，小于10s/20次，请求频率过快服务器会拒绝处理
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(VideoResultsV2Request, self).__init__(
            '/video:resultsv2', 'POST', header, version)
        self.parameters = parameters


class VideoResultsV2Parameters(object):
