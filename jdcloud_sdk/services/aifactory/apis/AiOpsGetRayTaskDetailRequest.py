...
class AiOpsGetRayTaskDetailRequest(JDCloudRequest):
    """
    Ray 任务详情
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(AiOpsGetRayTaskDetailRequest, self).__init__(
            '/regions/{regionId}/apps/{appName}/aiOpsGetRayTaskDetail', 'POST', header, version)
        self.parameters = parameters


class AiOpsGetRayTaskDetailParameters(object):
