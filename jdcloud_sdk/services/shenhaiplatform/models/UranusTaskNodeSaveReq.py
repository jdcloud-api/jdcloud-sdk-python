...
class UranusTaskNodeSaveReq(object):

    def __init__(self, taskName=None, childrenCode=None, parentCode=None, taskDesc=None, taskNodeId=None, taskCode=None, manager=None, taskData=None, nodeName=None, nodeTypeName=None, nodeIcon=None, flowCode=None, fileCode=None, jobName=None, isUranus=None, isCurrentFlow=None, parent=None, haveChildren=None, cooperator=None):
        """
