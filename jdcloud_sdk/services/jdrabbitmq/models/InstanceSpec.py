...
class InstanceSpec(object):
    ...
    def __init__(self, vpcId, subnetId, instanceVersion, instanceName, azId, instanceClassSpec, extension=None, cpuArch=None, opsTags=None, userTags=None):
        ...
        :param instanceVersion:  rabbitmq版本，[1.0.1,0.10.2,2.4,2.6.0]
        :param instanceName:  rabbitmq集群名称，不可为空，只支持大小写字母、数字、英文下划线或者中划线，以字母开头且不能超过32位
        :param azId:  可用区
        ...
        :param userTags: (Optional) 用户自定义标签的Tag键值对
        """
