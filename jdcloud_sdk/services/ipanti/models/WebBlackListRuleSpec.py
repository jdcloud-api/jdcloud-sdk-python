...
class WebBlackListRuleSpec(object):
    ...
    def __init__(self, name, mode, value, action, status, key=None, pattern=None, actionValue=None, pageId=None):
        """
        :param name:  黑名单规则名称
        ...
        :param action:  命中后处理动作. <br>- 0: 封禁并返回自定义页面<br>- 1: 跳转<br>- 2: 验证码
