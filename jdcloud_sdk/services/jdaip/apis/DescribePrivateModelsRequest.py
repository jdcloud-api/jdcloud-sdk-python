...
class DescribePrivateModelsRequest(JDCloudRequest):
    """
    查询私有模型列表
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(DescribePrivateModelsRequest, self).__init__(
            '/model-regions/{regionId}/workspace/{workspaceId}/model', 'GET', header, version)
        self.parameters = parameters


class DescribePrivateModelsParameters(object):
