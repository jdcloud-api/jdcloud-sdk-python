...
class DataDiskSpec(object):
    ...
    def __init__(self, diskType, diskSizeGB, fsType, iops=None, snapshotId=None, autoDelete=None, autoFormat=None, mountPoint=None):
        """
        ...
        :param autoDelete: (Optional) 随虚机删除，默认true
        :param autoFormat: (Optional) 自动format，默认true
        :param fsType:  支持ext4,xfs
        :param mountPoint: (Optional) 挂载点，默认 /var/lib/docker
        """
