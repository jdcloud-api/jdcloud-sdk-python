...
class DescribeNodeListRequest(JDCloudRequest):
    """
    获取缓存Redis实例的节点列表，可分页、可搜索
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(DescribeNodeListRequest, self).__init__(
            '/regions/{regionId}/cacheInstance/{cacheInstanceId}/node', 'GET', header, version)
        self.parameters = parameters


class DescribeNodeListParameters(object):
