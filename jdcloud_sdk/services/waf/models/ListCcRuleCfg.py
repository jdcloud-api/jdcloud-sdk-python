...
class ListCcRuleCfg(object):
    ...
    def __init__(self, wafInstanceId=None, domain=None, ruleName=None, uri=None, matchType=None, detectPeriod=None, singleIpLimit=None, blockType=None, blockTime=None, updateTime=None, disable=None):
        """
