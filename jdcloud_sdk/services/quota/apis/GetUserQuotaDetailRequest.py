...
class GetUserQuotaDetailRequest(JDCloudRequest):
    """
    校验配额 
    """

    def __init__(self, parameters, header=None, version="v2"):
        super(GetUserQuotaDetailRequest, self).__init__(
            '/regions/{regionId}/userQuota:getDetail', 'POST', header, version)
        self.parameters = parameters


class GetUserQuotaDetailParameters(object):
