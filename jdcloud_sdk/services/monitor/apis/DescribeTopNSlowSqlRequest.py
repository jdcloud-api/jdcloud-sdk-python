...
class DescribeTopNSlowSqlRequest(JDCloudRequest):
    """
    查看sqlserver数据库某资源一段时间内的topN慢sql数据
    """

    def __init__(self, parameters, header=None, version=""):
        super(DescribeTopNSlowSqlRequest, self).__init__(
            '/regions/{regionId}/topNSql', 'GET', header, version)
        self.parameters = parameters


class DescribeTopNSlowSqlParameters(object):

    def __init__(self, regionId, resourceId, serviceCode, topN):
        """
        :param regionId: region
        :param resourceId: 资源的uuid
        :param serviceCode: 资源的类型,sqlserver
        :param topN: topN数量
        """
