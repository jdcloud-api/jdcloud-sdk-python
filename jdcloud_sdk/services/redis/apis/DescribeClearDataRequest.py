...
class DescribeClearDataRequest(JDCloudRequest):
    """
    查询数据清理任务进度
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(DescribeClearDataRequest, self).__init__(
            '/regions/{regionId}/cacheInstance/{cacheInstanceId}/describeClearData', 'GET', header, version)
        self.parameters = parameters


class DescribeClearDataParameters(object):
