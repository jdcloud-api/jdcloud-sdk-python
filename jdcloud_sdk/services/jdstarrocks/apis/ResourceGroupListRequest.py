...
class ResourceGroupListRequest(JDCloudRequest):
    """
    资源组列表
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(ResourceGroupListRequest, self).__init__(
            '/regions/{regionId}/apps/{appName}/resourceGroupList', 'POST', header, version)
