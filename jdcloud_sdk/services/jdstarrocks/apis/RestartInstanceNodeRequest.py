...
class RestartInstanceNodeRequest(JDCloudRequest):
    """
    重启实例节点
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(RestartInstanceNodeRequest, self).__init__(
            '/regions/{regionId}/apps/{appName}/restartInstanceNode', 'POST', header, version)
        self.parameters = parameters


class RestartInstanceNodeParameters(object):
