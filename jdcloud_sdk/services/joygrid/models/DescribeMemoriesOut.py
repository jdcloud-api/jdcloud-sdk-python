...
class DescribeMemoriesOut(object):

    def __init__(self, memories=None, numberPages=None, numberRecords=None, pageNumber=None, pageSize=None):
        """
        :param memories: (Optional) 
