...
class SetExposeTypeRequest(JDCloudRequest):
    """
    设置缓存Redis实例的外部访问方式
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(SetExposeTypeRequest, self).__init__(
            '/regions/{regionId}/cacheInstance/{cacheInstanceId}:setExposeType', 'POST', header, version)
        self.parameters = parameters


class SetExposeTypeParameters(object):
    ...
    def setExposeType(self, exposeType):
        """
