...
class ExportLiveTranscodingDurationDataRequest(JDCloudRequest):
    """
    导出转码时长数据
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(ExportLiveTranscodingDurationDataRequest, self).__init__(
            '/exportLiveTranscodingDurationData', 'GET', header, version)
        self.parameters = parameters


class ExportLiveTranscodingDurationDataParameters(object):
