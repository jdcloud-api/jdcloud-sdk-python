...
class BatchSetDNS(object):
    ...
    def __init__(self, hostRecord, hostValue, id, ttl, type, viewValue, jcloudRes=None, mxPriority=None, port=None, weight=None):
        """
        :param hostRecord:  主机记录
        :param hostValue:  解析记录的值
        :param id:  解析记录的ID, 如果是新增请填0，如果是更新，请使用describeResourceRecord接口查询解析记录ID。
