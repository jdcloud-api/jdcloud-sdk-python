...
class UpdateViTemplateRequestInfo(object):

    def __init__(self, templateName=None, shotInterval=None, shotIntervalType=None, shotFormat=None, shotFrameType=None, shotWidth=None, shotHeight=None, shotFillType=None, inspectItems=None):
        """
