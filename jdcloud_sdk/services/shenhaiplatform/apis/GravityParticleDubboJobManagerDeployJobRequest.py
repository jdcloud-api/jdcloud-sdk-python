...
class GravityParticleDubboJobManagerDeployJobRequest(JDCloudRequest):
    """
    发布作业
    """

    def __init__(self, parameters, header=None, version="v2"):
        super(GravityParticleDubboJobManagerDeployJobRequest, self).__init__(
            '/regions/{regionId}/apps/{appName}/gravityParticleDubboJobManagerDeployJob', 'POST', header, version)
        self.parameters = parameters


class GravityParticleDubboJobManagerDeployJobParameters(object):
