...
class InternalNetinfo(object):

    def __init__(self, appId=None, userRoomId=None, userId=None, nickName=None, connectId=None, networkType=None, internalIp=None, extranetIp=None, location=None, netScore=None, status=None, joinTime=None, updateTime=None):
        """
        ...
        :param internalIp: (Optional) 内网IP
        :param extranetIp: (Optional) 外网IP
        :param location: (Optional) 地理位置
        :param netScore: (Optional) 网络连接质量，取值1~10
