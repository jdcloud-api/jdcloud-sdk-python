...
class AreaIspbdwDetailItem(object):

    def __init__(self, area=None, isp=None, flowPercent=None, pvPercent=None, avgbandwidth=None, flow=None, pv=None, topTimeStamp=None):
        """
        :param area: (Optional) 
        :param isp: (Optional) 
