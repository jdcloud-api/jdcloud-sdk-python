...
class ServerlessClusterNetworkConfig(object):

    def __init__(self, publicApiServer=None, masterCidr=None, serviceCidr=None, vpcId=None, podSubnets=None, lbSubnets=None, natGateways=None):
        """
        ...
        :param lbSubnets: (Optional) 集群lb子网信息
        :param natGateways: (Optional) nat网关配置
        """
