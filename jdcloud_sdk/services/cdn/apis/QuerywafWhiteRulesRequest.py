...
class QuerywafWhiteRulesRequest(JDCloudRequest):
    """
    查询WAF白名单规则列表
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(QuerywafWhiteRulesRequest, self).__init__(
            '/domain/{domain}/wafWhiteRules', 'GET', header, version)
        self.parameters = parameters


class QuerywafWhiteRulesParameters(object):
