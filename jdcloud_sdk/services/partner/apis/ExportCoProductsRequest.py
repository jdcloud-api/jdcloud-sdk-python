...
class ExportCoProductsRequest(JDCloudRequest):
    """
    合作产品列表导出
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(ExportCoProductsRequest, self).__init__(
            '/regions/{regionId}/CooperationInfo:exportCoProducts', 'POST', header, version)
        self.parameters = parameters


class ExportCoProductsParameters(object):
