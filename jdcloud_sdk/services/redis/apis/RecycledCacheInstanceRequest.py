...
class RecycledCacheInstanceRequest(JDCloudRequest):
    """
    查询回收站里缓存Redis实例列表，可分页、可排序、可搜索、可过滤
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(RecycledCacheInstanceRequest, self).__init__(
            '/regions/{regionId}/recycledCacheInstance', 'GET', header, version)
        self.parameters = parameters


class RecycledCacheInstanceParameters(object):
