...
class AudioStreamSettings(object):
    ...
    def __init__(self, encoding=None, codec=None, bitrate=None, sampleRate=None, channels=None, comfortable=None):
        """
        :param encoding: (Optional) 音频转码。取值范围：copy, disable, encode; 默认encode
        :param codec: (Optional) 音频编码(encoding=encode时必填)。取值范围：aac 。目前仅支持 acc
        :param bitrate: (Optional) 音频目标码率(encoding=encode时必填)。取值范围：[8, 1000]，单位为 Kbps
