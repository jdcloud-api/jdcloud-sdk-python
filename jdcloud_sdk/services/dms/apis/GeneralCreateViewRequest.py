...
class GeneralCreateViewRequest(JDCloudRequest):
    """
    生产创建视图SQL语句，支持Mysql
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(GeneralCreateViewRequest, self).__init__(
            '/regions/{regionId}/view:generalCreate', 'POST', header, version)
        self.parameters = parameters


class GeneralCreateViewParameters(object):
