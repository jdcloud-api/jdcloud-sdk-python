...
class UranusWorkFlowDirDeleteRequest(JDCloudRequest):
    """
    删除文件夹
    """

    def __init__(self, parameters, header=None, version="v2"):
        super(UranusWorkFlowDirDeleteRequest, self).__init__(
            '/regions/{regionId}/apps/{appName}/uranusWorkFlowDirDelete', 'POST', header, version)
        self.parameters = parameters


class UranusWorkFlowDirDeleteParameters(object):
