...
class JDCloudVolumeSourceSpec(object):

    def __init__(self, fsType, volumeId=None, name=None, snapshotId=None, diskType=None, sizeGB=None, formatVolume=None, iops=None, autoDelete=None):
        """
