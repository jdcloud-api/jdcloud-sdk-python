...
class ModifyDedicatedHostAttributeRequest(JDCloudRequest):
    """
    修改专有宿主机部分属性，包括名称、描述。
    ...
    def __init__(self, parameters, header=None, version="v1"):
        super(ModifyDedicatedHostAttributeRequest, self).__init__(
            '/regions/{regionId}/dedicatedHost/{dedicatedHostId}:modifyAttribute', 'POST', header, version)
