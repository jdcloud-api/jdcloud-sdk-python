...
class TrafficMirrorFilterRule(object):

    def __init__(self, mirrorFilterRuleId=None, direction=None, protocol=None, action=None, priority=None, sourceCidr=None, destinationCidr=None, sourcePortStart=None, sourcePortEnd=None, destinationPortStart=None, destinationPortEnd=None, createdTime=None):
        """
        :param mirrorFilterRuleId: (Optional) 过滤器规则的ID
