...
class AddDomain(object):
    ...
    def __init__(self, wafInstanceId, domain, protocols, lbType, rsConfig, sslProtocols=None, pureClient=None, httpsRedirect=None, rsOnlySupportHttp=None, httpVersion=None, suiteLevel=None):
        """
