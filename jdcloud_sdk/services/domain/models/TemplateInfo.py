...
class TemplateInfo(object):
    ...
    def __init__(self, userNameCh=None, userNameEn1=None, userNameEn2=None, ownerNameCh=None, ownerNameEn=None, nationCodeCh=None, nationCodeEn=None, provinceCodeCh=None, provinceCodeEn=None, cityCodeCh=None, cityCodeEn=None, addressCh=None, addressEn=None, zipCode=None, phone=None, fax=None, email=None, ownerType=None, certificateStatus=None, certificateUnpassReason=None, modified=None):
        """
        :param userNameCh: (Optional) 联系人姓名(中文)
        :param userNameEn1: (Optional) 联系人姓(英文)
        :param userNameEn2: (Optional) 联系人名(英文)
        :param ownerNameCh: (Optional) 域名所有者或所有者单位名称(中文)
        :param ownerNameEn: (Optional) 域名所有者或所有者单位名称(英文)
        ...
        :param certificateStatus: (Optional) 实名认证状态 0未实名认证 1已实名认证 2审核中 3审核失败 4实名资料上传注册局失败
        :param certificateUnpassReason: (Optional) 实名认证失败原因
        ...
        self.certificateUnpassReason = certificateUnpassReason
