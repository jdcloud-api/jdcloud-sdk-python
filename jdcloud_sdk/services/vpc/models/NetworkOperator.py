...
class NetworkOperator(object):
    ...
    def __init__(self, provider=None, networkOperator=None, flowType=None, configType=None, billItem=None, bwpCharge=None, ccProvider=None, providerType=None, providerNameCN=None, bandwidthLimits=None):
        """
        ...
        :param bwpCharge: (Optional) 带宽包计费相关信息
