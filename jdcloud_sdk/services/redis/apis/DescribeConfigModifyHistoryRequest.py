...
class DescribeConfigModifyHistoryRequest(JDCloudRequest):
    """
    获取实例参数修改历史，可分页、可搜索
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(DescribeConfigModifyHistoryRequest, self).__init__(
            '/regions/{regionId}/cacheInstance/{cacheInstanceId}/instanceConfigModifyHistory', 'GET', header, version)
        self.parameters = parameters


class DescribeConfigModifyHistoryParameters(object):
