...
class CacheDateHistogramBandwidthRequest(JDCloudRequest):
    """
    按响应带宽统计，返回日期直方图。
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(CacheDateHistogramBandwidthRequest, self).__init__(
            '/zones/{zone_identifier}/analytics$$cacheDateHistogramBandwidth', 'POST', header, version)
        self.parameters = parameters


class CacheDateHistogramBandwidthParameters(object):
