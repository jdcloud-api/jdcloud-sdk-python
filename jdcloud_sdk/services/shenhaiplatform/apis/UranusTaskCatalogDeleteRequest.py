...
class UranusTaskCatalogDeleteRequest(JDCloudRequest):
    """
    删除业务目录
    """

    def __init__(self, parameters, header=None, version="v2"):
        super(UranusTaskCatalogDeleteRequest, self).__init__(
            '/regions/{regionId}/apps/{appName}/uranusTaskCatalogDelete', 'POST', header, version)
        self.parameters = parameters


class UranusTaskCatalogDeleteParameters(object):
