...
class AdminDescribeNotebookCountRequest(JDCloudRequest):
    """
...
- rolled-back: 已回滚
    ...
    def __init__(self, parameters, header=None, version="v1"):
        super(AdminDescribeNotebookCountRequest, self).__init__(
            '/nb-regions/{regionId}/api/{apiType}/notebook:count', 'GET', header, version)
        self.parameters = parameters


class AdminDescribeNotebookCountParameters(object):
