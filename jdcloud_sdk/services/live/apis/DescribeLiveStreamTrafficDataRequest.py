...
class DescribeLiveStreamTrafficDataRequest(JDCloudRequest):
    """
    查询流量数据
- 查询某个时间段内的流量数据。
- 查询1分钟粒度的数据时，时间跨度不超过7天，其他粒度时时间跨度不超过30天
    ...
    def __init__(self, parameters, header=None, version="v1"):
        super(DescribeLiveStreamTrafficDataRequest, self).__init__(
            '/describeLiveStreamTrafficData', 'GET', header, version)
