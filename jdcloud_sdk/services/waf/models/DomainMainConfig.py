...
class DomainMainConfig(object):
    ...
    def __init__(self, domain=None, cname=None, certName=None, vip=None, protocols=None, sslProtocols=None, pureClient=None, httpStatus=None, antiStatus=None, disableWaf=None, attackInfo=None, dnsStatus=None, enableCname2Rs=None):
        """
        :param domain: (Optional) 域名
        :param cname: (Optional) cname域名
        :param certName: (Optional) 绑定的证书名称
        :param vip: (Optional) vip
