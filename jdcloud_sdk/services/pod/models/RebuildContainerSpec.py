...
class RebuildContainerSpec(object):
    ...
    def __init__(self, containerName, image, command=None, args=None, env=None, secret=None, tty=None, workingDir=None, livenessProbe=None, readinessProbe=None, volumeMounts=None):
        """
