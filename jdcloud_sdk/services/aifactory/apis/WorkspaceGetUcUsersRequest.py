...
class WorkspaceGetUcUsersRequest(JDCloudRequest):
    """
    获取可添加的成员列表
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(WorkspaceGetUcUsersRequest, self).__init__(
            '/regions/{regionId}/apps/{appName}/workspaceGetUcUsers', 'POST', header, version)
        self.parameters = parameters


class WorkspaceGetUcUsersParameters(object):
