...
class AddBandwidthPackageIpRequest(JDCloudRequest):
    ...
    def __init__(self, parameters, header=None, version="v1"):
        super(AddBandwidthPackageIpRequest, self).__init__(
            '/regions/{regionId}/bandwidthPackages/{bandwidthPackageId}:addBandwidthPackageIp', 'PUT', header, version)
        self.parameters = parameters


class AddBandwidthPackageIpParameters(object):

    def __init__(self, regionId, bandwidthPackageId, elasticIpIds):
        """
        :param regionId: 地域ID，可调用接口（describeEdCPSRegions）获取分布式云物理服务器支持的地域
        :param bandwidthPackageId: 共享带宽ID
        :param elasticIpIds: 弹性公网IP ID
        """
