...
class SetUserAntiCfgReq(object):
    ...
    def __init__(self, wafInstanceId, domain, filterHeaderEnable=None, filterSenseEnable=None, skipEnable=None, denyEnable=None, ratelimitEnable=None, uriRewriteEnable=None):
        """
        :param wafInstanceId:  WAF实例id
        :param domain:  域名
        :param filterHeaderEnable: (Optional) 是否开启头管理，"1"表示使能,"0"表示否
