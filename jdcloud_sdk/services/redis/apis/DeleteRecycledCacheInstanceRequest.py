...
class DeleteRecycledCacheInstanceRequest(JDCloudRequest):
    """
    ...
    def __init__(self, parameters, header=None, version="v1"):
        super(DeleteRecycledCacheInstanceRequest, self).__init__(
            '/regions/{regionId}/recycledCacheInstance/{cacheInstanceId}', 'DELETE', header, version)
        self.parameters = parameters


class DeleteRecycledCacheInstanceParameters(object):
