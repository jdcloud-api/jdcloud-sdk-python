...
class UranusTaskNodeUpdateNodeDataRequest(JDCloudRequest):
    """
    任务单节点-更新节点位置信息
    """

    def __init__(self, parameters, header=None, version="v2"):
        super(UranusTaskNodeUpdateNodeDataRequest, self).__init__(
            '/regions/{regionId}/apps/{appName}/uranusTaskNodeUpdateNodeData', 'POST', header, version)
        self.parameters = parameters


class UranusTaskNodeUpdateNodeDataParameters(object):
