...
class QueryDomainsLogForJdRequest(JDCloudRequest):
    """
    批量域名查询日志-pin维度
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(QueryDomainsLogForJdRequest, self).__init__(
            '/logsJd', 'POST', header, version)
        self.parameters = parameters


class QueryDomainsLogForJdParameters(object):
