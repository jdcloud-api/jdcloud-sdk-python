...
class AzId(object):
    ...
    def __init__(self, azSpecifyType=None, azsForCluster=None, master=None, slave=None, azsForProxy=None):
        """
        ...
        :param azsForProxy: (Optional) 代理AZ范围
        """
