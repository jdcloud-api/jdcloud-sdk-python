...
class ProductBill(object):

    def __init__(self, billDate=None, pin=None, loginName=None, customerName=None, appCode=None, appCodeName=None, serviceCode=None, serviceCodeName=None, billFee=None, billFee2=None, discountFee=None, eraseFee=None, actualFee=None, payCouponFee=None, discount=None, payableFee=None, freeCouponFee=None, balancePayFee=None, cashPayFee=None):
        """
