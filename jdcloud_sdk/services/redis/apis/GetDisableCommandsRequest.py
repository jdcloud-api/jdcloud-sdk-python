...
class GetDisableCommandsRequest(JDCloudRequest):
    """
    获取禁用命令列表
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(GetDisableCommandsRequest, self).__init__(
            '/regions/{regionId}/cacheInstance/{cacheInstanceId}/disableCommands', 'GET', header, version)
        self.parameters = parameters


class GetDisableCommandsParameters(object):
