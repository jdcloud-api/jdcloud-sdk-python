...
class QueryStatisticsDataGroupSumRequest(JDCloudRequest):
    """
    查询统计数据并进行汇总加和
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(QueryStatisticsDataGroupSumRequest, self).__init__(
            '/vodStatistics:groupSum', 'POST', header, version)
...
class QueryStatisticsDataGroupSumParameters(object):
    ...
    def setGroupBy(self, groupBy):
        """
        :param groupBy: (Optional) 分组依据，可选值：[area,isp,domain,scheme]
        """
