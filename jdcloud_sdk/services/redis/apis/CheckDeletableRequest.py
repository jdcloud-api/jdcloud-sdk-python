...
class CheckDeletableRequest(JDCloudRequest):
    """
    检查实例是否可以被安全删除
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(CheckDeletableRequest, self).__init__(
            '/regions/{regionId}/cacheInstance/{cacheInstanceId}/checkDeletable', 'POST', header, version)
        self.parameters = parameters


class CheckDeletableParameters(object):
