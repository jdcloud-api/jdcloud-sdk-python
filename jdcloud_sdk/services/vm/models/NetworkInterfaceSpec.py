...
class NetworkInterfaceSpec(object):
    ...
    def __init__(self, subnetId, az=None, networkInterfaceName=None, primaryIpAddress=None, secondaryIpAddresses=None, secondaryIpCount=None, securityGroups=None, sanityCheck=None, description=None, ipv6Address=None, ipv6AddressCount=None):
        """
        :param subnetId:  子网ID
        ...
        :param ipv6Address: (Optional) 指定随网卡创建的ipv6地址
        :param ipv6AddressCount: (Optional) 自动分配的ipv6地址数量，不支持同时指定地址和自动分配。
        """
