...
class CreateMonitorTargetRequest(JDCloudRequest):
    """
    添加子域名的某些特定监控对象为监控项
    """

    def __init__(self, parameters, header=None, version="v2"):
        super(CreateMonitorTargetRequest, self).__init__(
            '/regions/{regionId}/domain/{domainId}/monitorTarget', 'POST', header, version)
        self.parameters = parameters


class CreateMonitorTargetParameters(object):
