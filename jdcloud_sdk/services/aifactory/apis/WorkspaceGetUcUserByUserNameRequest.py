...
class WorkspaceGetUcUserByUserNameRequest(JDCloudRequest):
    """
    根据用户名称模糊查询当前工作空间下的用户
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(WorkspaceGetUcUserByUserNameRequest, self).__init__(
            '/regions/{regionId}/apps/{appName}/workspaceGetUcUserByUserName', 'POST', header, version)
        self.parameters = parameters


class WorkspaceGetUcUserByUserNameParameters(object):
