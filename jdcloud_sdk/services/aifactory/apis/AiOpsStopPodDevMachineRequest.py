...
class AiOpsStopPodDevMachineRequest(JDCloudRequest):
    """
    停止 Pod 开发机
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(AiOpsStopPodDevMachineRequest, self).__init__(
            '/regions/{regionId}/apps/{appName}/aiOpsStopPodDevMachine', 'POST', header, version)
        self.parameters = parameters


class AiOpsStopPodDevMachineParameters(object):
