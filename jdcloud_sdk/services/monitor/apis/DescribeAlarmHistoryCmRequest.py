...
class DescribeAlarmHistoryCmRequest(JDCloudRequest):
    """
    查询自定义监控规则告警历史
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(DescribeAlarmHistoryCmRequest, self).__init__(
            '/regions/{regionId}/cm/alarmHistory', 'GET', header, version)
        self.parameters = parameters


class DescribeAlarmHistoryCmParameters(object):
