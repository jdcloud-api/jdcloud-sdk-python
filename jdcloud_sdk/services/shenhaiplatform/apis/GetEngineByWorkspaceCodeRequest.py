...
class GetEngineByWorkspaceCodeRequest(JDCloudRequest):
    """
    通过工作空间Code查询绑定的计算引擎列表
    """

    def __init__(self, parameters, header=None, version="v2"):
        super(GetEngineByWorkspaceCodeRequest, self).__init__(
            '/regions/{regionId}/apps/{appName}/getEngineByWorkspaceCode', 'POST', header, version)
        self.parameters = parameters


class GetEngineByWorkspaceCodeParameters(object):
