...
class Video(object):
    ...
    def __init__(self, mid=None, videoName=None, url=None, imgUrl=None, categoryId=None, category=None, status=None, size=None, duration=None, tags=None, coderateId=None, logoId=None, md5=None, clientIp=None, clientId=None, endpoint=None, bucket=None, createTime=None, updateTime=None, codeList=None, categorys=None):
        """
        ...
        :param codeList: (Optional) 码率信息
        :param categorys: (Optional) 分类父级信息信息
        """
