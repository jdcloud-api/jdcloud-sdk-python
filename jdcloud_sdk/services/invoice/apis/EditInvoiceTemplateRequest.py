...
class EditInvoiceTemplateRequest(JDCloudRequest):
    """
    修改发票模版
    """

    def __init__(self, parameters, header=None, version="v2"):
        super(EditInvoiceTemplateRequest, self).__init__(
            '/regions/{regionId}/editInvoiceTemplate', 'PUT', header, version)
        self.parameters = parameters


class EditInvoiceTemplateParameters(object):
