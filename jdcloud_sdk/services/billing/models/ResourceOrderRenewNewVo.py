...
class ResourceOrderRenewNewVo(object):

    def __init__(self, id=None, transactionNo=None, resourceId=None, billingType=None, timeUnit=None, timeSpan=None, status=None, billingStatus=None, networkOperator=None, pin=None, appCode=None, serviceCode=None, serviceName=None, site=None, region=None, regionName=None, formula=None, isOnTrial=None, startTime=None, endTime=None, createTime=None, payTime=None, formulaStr=None, chargeMode=None, chargeDuration=None, chargeUnit=None, aeStatus=None, releasingTime=None, sourceId=None, billingStartTime=None, priceMap=None, priceSnapshot=None, price=None, discountedPrice=None, expiringDays=None, billingCategoryDescription=None, description=None, refundNo=None, billingTypeName=None, favorableInfo=None, resourceName=None, processType=None, applicant=None, billingMode=None, operateTime=None, arrearsType=None, recycleBinReleasingTime=None, remark=None, tag=None, bindResources=None):
        """
        ...
        :param serviceName: (Optional) 产品线中文名称
        ...
        :param remark: (Optional) 扩展信息
        :param tag: (Optional) 标签信息
        :param bindResources: (Optional) 绑定资源
        """
