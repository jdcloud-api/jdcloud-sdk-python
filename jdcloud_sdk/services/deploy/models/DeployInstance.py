...
class DeployInstance(object):
    ...
    def __init__(self, deployId=None, uuid=None, instanceName=None, ip=None, public_ip=None, regionId=None, vpc=None, type=None, ag=None, tags=None, groupId=None, method=None, status=None):
        """
        ...
        :param method: (Optional) 部署方式：1滚动 2蓝组 3绿组
        :param status: (Optional) 部署状态
        """
