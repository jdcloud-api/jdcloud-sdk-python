...
class DisableWebRuleCCObserverModeRequest(JDCloudRequest):
    """
    ...
    def __init__(self, parameters, header=None, version="v1"):
        super(DisableWebRuleCCObserverModeRequest, self).__init__(
            '/regions/{regionId}/instances/{instanceId}/webRules/{webRuleId}:disableCCObserverMode', 'POST', header, version)
        self.parameters = parameters


class DisableWebRuleCCObserverModeParameters(object):
