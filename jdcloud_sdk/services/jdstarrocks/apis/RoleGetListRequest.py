...
class RoleGetListRequest(JDCloudRequest):
    """
    获取角色列表
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(RoleGetListRequest, self).__init__(
            '/regions/{regionId}/apps/{appName}/roleGetList', 'POST', header, version)
        self.parameters = parameters


class RoleGetListParameters(object):
