...
class StartInstancesRequest(JDCloudRequest):
    """
    ...
    def __init__(self, parameters, header=None, version="v1"):
        super(StartInstancesRequest, self).__init__(
            '/regions/{regionId}/instances:startInstances', 'PUT', header, version)
        self.parameters = parameters


class StartInstancesParameters(object):

    def __init__(self, regionId, instanceIds):
        """
        :param regionId: 地域ID，可调用接口（describeRegiones）获取云物理服务器支持的地域
        :param instanceIds: 资源id列表
        """
