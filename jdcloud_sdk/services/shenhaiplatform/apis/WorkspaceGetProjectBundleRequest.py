...
class WorkspaceGetProjectBundleRequest(JDCloudRequest):
    """
    获取云仓项目被绑定的工作空间
    """

    def __init__(self, parameters, header=None, version="v2"):
        super(WorkspaceGetProjectBundleRequest, self).__init__(
            '/regions/{regionId}/apps/{appName}/workspaceGetProjectBundle', 'POST', header, version)
        self.parameters = parameters


class WorkspaceGetProjectBundleParameters(object):
