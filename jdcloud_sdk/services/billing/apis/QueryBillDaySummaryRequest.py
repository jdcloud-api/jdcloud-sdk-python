...
class QueryBillDaySummaryRequest(JDCloudRequest):
    """
    查询账单资源天汇总数据
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(QueryBillDaySummaryRequest, self).__init__(
            '/regions/{regionId}/billDaySummary:list', 'POST', header, version)
        self.parameters = parameters


class QueryBillDaySummaryParameters(object):
