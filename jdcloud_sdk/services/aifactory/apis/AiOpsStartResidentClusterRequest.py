...
class AiOpsStartResidentClusterRequest(JDCloudRequest):
    """
    启动常驻集群
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(AiOpsStartResidentClusterRequest, self).__init__(
            '/regions/{regionId}/apps/{appName}/aiOpsStartResidentCluster', 'POST', header, version)
        self.parameters = parameters


class AiOpsStartResidentClusterParameters(object):
