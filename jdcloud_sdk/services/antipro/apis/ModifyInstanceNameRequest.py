...
class ModifyInstanceNameRequest(JDCloudRequest):
    ...
    def __init__(self, parameters, header=None, version="v1"):
        super(ModifyInstanceNameRequest, self).__init__(
            '/regions/{regionId}/instances/{instanceId}:modifyInstanceName', 'PATCH', header, version)
        self.parameters = parameters


class ModifyInstanceNameParameters(object):

    def __init__(self, regionId, instanceId, modifyInstanceNameSpec):
        """
        :param regionId: 地域编码
        :param instanceId: 防护包实例 Id
        :param modifyInstanceNameSpec: 修改防护包实例名称请求参数
        """
