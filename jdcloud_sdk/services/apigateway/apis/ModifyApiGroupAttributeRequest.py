...
class ModifyApiGroupAttributeRequest(JDCloudRequest):
    """
    修改API分组信息
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(ModifyApiGroupAttributeRequest, self).__init__(
            '/regions/{regionId}/apiGroups/{apiGroupId}', 'PUT', header, version)
        self.parameters = parameters


class ModifyApiGroupAttributeParameters(object):
