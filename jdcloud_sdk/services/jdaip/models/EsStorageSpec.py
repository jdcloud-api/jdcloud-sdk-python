...
class EsStorageSpec(object):

    def __init__(self, storageType, storageId, storagePath, mountPath, readonly=None):
        """
...
系统目录参考：/, /bin, /boot, /dev, /etc, /home, /lib, /lib32, /lib64, /libx32, /opt, /proc, /root, /run, /sbin, /sys, /tmp, /usr, /var。
        ...
        :param readonly: (Optional) 是否以只读模式挂载存储。只读模式下，用户无法在挂载的存储中进行写操作。仅当存储类型为oss时有效。
