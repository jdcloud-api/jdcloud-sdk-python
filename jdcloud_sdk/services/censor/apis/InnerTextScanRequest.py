...
class InnerTextScanRequest(JDCloudRequest):
    """
    文本同步检测-检测文本中是否包含违规信息
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(InnerTextScanRequest, self).__init__(
            '/text:innerscan', 'POST', header, version)
        self.parameters = parameters


class InnerTextScanParameters(object):
