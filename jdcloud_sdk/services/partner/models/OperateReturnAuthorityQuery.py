...
class OperateReturnAuthorityQuery(object):

    def __init__(self, id=None, erp=None, remark=None, operator=None, createTime=None, createUser=None, updateTime=None, updateUser=None, yn=None, pageIndex=None, pageSize=None, offset=None):
        """
