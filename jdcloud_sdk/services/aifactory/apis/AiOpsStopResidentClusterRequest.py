...
class AiOpsStopResidentClusterRequest(JDCloudRequest):
    """
    停止常驻集群
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(AiOpsStopResidentClusterRequest, self).__init__(
            '/regions/{regionId}/apps/{appName}/aiOpsStopResidentCluster', 'POST', header, version)
        self.parameters = parameters


class AiOpsStopResidentClusterParameters(object):
