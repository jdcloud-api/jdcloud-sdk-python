...
class CreateServerGroupRequest(JDCloudRequest):
    """
    创建虚拟服务器组
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(CreateServerGroupRequest, self).__init__(
            '/regions/{regionId}/serverGroups', 'PUT', header, version)
        self.parameters = parameters


class CreateServerGroupParameters(object):
