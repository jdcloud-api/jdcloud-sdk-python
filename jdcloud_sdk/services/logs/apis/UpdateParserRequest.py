...
class UpdateParserRequest(JDCloudRequest):
    """
    更新解析配置
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(UpdateParserRequest, self).__init__(
            '/regions/{regionId}/logtopics/{logtopicUID}/updateParser', 'POST', header, version)
