...
class StartListenerRequest(JDCloudRequest):
    """
    开启监听器
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(StartListenerRequest, self).__init__(
            '/regions/{regionId}/listeners/{listenerId}:startListener', 'PUT', header, version)
        self.parameters = parameters


class StartListenerParameters(object):
