...
class UranusWorkFlowDirFileDeleteRequest(JDCloudRequest):
    """
    删除文件
    """

    def __init__(self, parameters, header=None, version="v2"):
        super(UranusWorkFlowDirFileDeleteRequest, self).__init__(
            '/regions/{regionId}/apps/{appName}/uranusWorkFlowDirFileDelete', 'POST', header, version)
        self.parameters = parameters


class UranusWorkFlowDirFileDeleteParameters(object):
