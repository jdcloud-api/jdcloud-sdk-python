...
class DescribeTrxLocksRequest(JDCloudRequest):
    """
    获取事务锁信息
    """

    def __init__(self, parameters, header=None, version="v2"):
        super(DescribeTrxLocksRequest, self).__init__(
            '/regions/{regionId}/instance/{instanceGid}/describeTrxLocks', 'GET', header, version)
        self.parameters = parameters


class DescribeTrxLocksParameters(object):
