...
class ModifyProtectionRuleOfForwardRuleRequest(JDCloudRequest):
    """
    修改非网站类转发规则的防护规则
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(ModifyProtectionRuleOfForwardRuleRequest, self).__init__(
            '/regions/{regionId}/instances/{instanceId}/forwardRules/{forwardRuleId}:modifyProtectionRule', 'POST', header, version)
...
class ModifyProtectionRuleOfForwardRuleParameters(object):
    ...
    def __init__(self, regionId,instanceId,forwardRuleId,forwardProtectionRuleSpec):
        ...
        :param forwardProtectionRuleSpec: 修改非网站类转发规则的防护规则请求参数
        """
