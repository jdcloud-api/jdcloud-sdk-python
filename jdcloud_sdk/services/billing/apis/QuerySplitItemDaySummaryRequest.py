...
class QuerySplitItemDaySummaryRequest(JDCloudRequest):
    """
    查询分账账单天汇总数据
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(QuerySplitItemDaySummaryRequest, self).__init__(
            '/regions/{regionId}/splitItemBillDaySummary:List', 'POST', header, version)
        self.parameters = parameters


class QuerySplitItemDaySummaryParameters(object):
