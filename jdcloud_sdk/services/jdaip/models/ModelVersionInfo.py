...
class ModelVersionInfo(object):
    ...
    def __init__(self, modelId=None, modelName=None, modelDescription=None, version=None, versionDesc=None, sourceType=None, baseModelId=None, baseModelName=None, storageType=None, storageDomain=None, storageBucket=None, storagePath=None, storageUri=None, storageId=None, cfsVpcId=None, modelIntroduction=None, labels=None, modelType=None, createTime=None, workspaceId=None, pin=None, createUser=None, updateTime=None, updateUser=None, experimentId=None, experimentRunId=None, ownerUser=None, ownerUserPin=None, permission=None):
        """
