...
class CreateMetricTaskSpec(object):

    def __init__(self, customUnit, interval, name, unit, aggregate=None, dataField=None, filterContent=None, filterOpen=None, filterType=None, metric=None, settingType=None, sqlSpec=None):
        """
