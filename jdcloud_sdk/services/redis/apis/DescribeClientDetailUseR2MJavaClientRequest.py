...
class DescribeClientDetailUseR2MJavaClientRequest(JDCloudRequest):
    """
    查询通过r2m java客户端接入的客户端详细信息，并统计使用的各版本客户端数量
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(DescribeClientDetailUseR2MJavaClientRequest, self).__init__(
            '/regions/{regionId}/cacheInstance/{cacheInstanceId}/clientDetail', 'GET', header, version)
        self.parameters = parameters


class DescribeClientDetailUseR2MJavaClientParameters(object):
