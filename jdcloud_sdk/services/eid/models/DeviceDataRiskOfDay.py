...
class DeviceDataRiskOfDay(object):

    def __init__(self, allDevice=None, normal=None, tuoJiGua=None, forgery=None, cloudPhone=None, root=None, hook=None, duoKai=None, moNi=None, time=None):
        """
        ...
        :param time: (Optional) 时间，yyyy-mm-dd hh:mm:ss格式
        """
