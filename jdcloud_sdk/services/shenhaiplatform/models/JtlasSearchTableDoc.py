...
class JtlasSearchTableDoc(object):
    ...
    def __init__(self, id=None, projectCode=None, database=None, tableName=None, tableAlias=None, tableType=None, creator=None, metaType=None, createTime=None, lastModifyTime=None, location=None, inputFormat=None, outputFormat=None, userDefineTags=None, collectPersons=None, hasCollected=None, clickCount=None, fireFlag=None, env=None, bucketCols=None, bucketNum=None):
        ...
        :param fireFlag: (Optional) 是否热门文章
        :param env: (Optional) 环境信息dev或prod
