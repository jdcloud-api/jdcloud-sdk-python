...
class FirewallDateHistogramRequest(JDCloudRequest):
    """
    按防火墙事件数量统计，返回日期直方图.
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(FirewallDateHistogramRequest, self).__init__(
            '/zones/{zone_identifier}/analytics$$firewallDateHistogram', 'POST', header, version)
        self.parameters = parameters


class FirewallDateHistogramParameters(object):
