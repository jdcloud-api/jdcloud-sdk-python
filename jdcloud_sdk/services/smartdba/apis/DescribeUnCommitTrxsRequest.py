...
class DescribeUnCommitTrxsRequest(JDCloudRequest):
    """
    获取未提交事务信息
    """

    def __init__(self, parameters, header=None, version="v2"):
        super(DescribeUnCommitTrxsRequest, self).__init__(
            '/regions/{regionId}/instance/{instanceGid}/describeUnCommitTrxs', 'GET', header, version)
        self.parameters = parameters


class DescribeUnCommitTrxsParameters(object):
