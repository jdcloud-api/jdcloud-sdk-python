...
class DisableWebRuleCCRequest(JDCloudRequest):
    """
    ...
    def __init__(self, parameters, header=None, version="v1"):
        super(DisableWebRuleCCRequest, self).__init__(
            '/regions/{regionId}/instances/{instanceId}/webRules/{webRuleId}:disableCC', 'POST', header, version)
        self.parameters = parameters


class DisableWebRuleCCParameters(object):
