...
class DisassociateElasticIpLBRequest(JDCloudRequest):
    """
    解绑弹性公网IP
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(DisassociateElasticIpLBRequest, self).__init__(
            '/regions/{regionId}/slbs/{loadBalancerId}:disassociateElasticIp', 'PUT', header, version)
        self.parameters = parameters


class DisassociateElasticIpLBParameters(object):
