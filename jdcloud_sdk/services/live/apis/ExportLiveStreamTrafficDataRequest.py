...
class ExportLiveStreamTrafficDataRequest(JDCloudRequest):
    """
    导出流量数据
- 查询某个时间段内的流量数据。
- 查询1分钟粒度的数据时，时间跨度不超过7天，其他粒度时时间跨度不超过30天
    ...
    def __init__(self, parameters, header=None, version="v1"):
        super(ExportLiveStreamTrafficDataRequest, self).__init__(
            '/exportLiveStreamTrafficData', 'GET', header, version)
        self.parameters = parameters


class ExportLiveStreamTrafficDataParameters(object):
