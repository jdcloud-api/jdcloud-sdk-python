...
class BasicRuleDetail(object):

    def __init__(self, calculation, metric, metricName, operation, period, threshold, times, calculateUnit=None, downSample=None, noticeLevel=None):
        """
