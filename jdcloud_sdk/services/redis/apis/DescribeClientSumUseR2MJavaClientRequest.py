...
class DescribeClientSumUseR2MJavaClientRequest(JDCloudRequest):
    """
    查询通过r2m java客户端接入的客户端数量
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(DescribeClientSumUseR2MJavaClientRequest, self).__init__(
            '/regions/{regionId}/cacheInstance/{cacheInstanceId}/clientSum', 'GET', header, version)
        self.parameters = parameters


class DescribeClientSumUseR2MJavaClientParameters(object):
