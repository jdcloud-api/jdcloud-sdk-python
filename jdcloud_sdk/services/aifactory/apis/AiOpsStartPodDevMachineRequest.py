...
class AiOpsStartPodDevMachineRequest(JDCloudRequest):
    """
    启动 Pod 开发机
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(AiOpsStartPodDevMachineRequest, self).__init__(
            '/regions/{regionId}/apps/{appName}/aiOpsStartPodDevMachine', 'POST', header, version)
        self.parameters = parameters


class AiOpsStartPodDevMachineParameters(object):
