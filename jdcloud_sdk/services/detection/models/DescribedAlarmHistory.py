...
class DescribedAlarmHistory(object):
    ...
    def __init__(self, alarmId=None, dimension=None, dimensionName=None, durationTimes=None, noticeDurationTime=None, noticeLevel=None, noticeLevelTriggered=None, noticeTime=None, product=None, productName=None, receivers=None, region=None, resourceId=None, rule=None, ruleType=None, status=None, tags=None, value=None):
        """
