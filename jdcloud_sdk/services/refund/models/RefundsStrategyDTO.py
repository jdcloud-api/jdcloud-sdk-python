...
class RefundsStrategyDTO(object):

    def __init__(self, id=None, strategyType=None, refundChannelSwitch=None, refundWaySwitch=None, refundAreaSwitch=None, invoiceStatusSwitch=None, approveSwitch=None, refundOrderSwitch=None, serviceCode=None, priority=None, status=None, refundType=None, permissionList=None):
        """
        :param id: (Optional) 退款策略主键id(修改必传，新增不传)
        ...
        :param permissionList: (Optional) 权限列表,逗号分隔. erp,pin
        """
