...
class UpdateProbeTaskSpec(object):
    ...
    def __init__(self, probes, address=None, frequency=None, httpBody=None, httpCookie=None, httpHeader=None, name=None, port=None, targetId=None, targetRegion=None, timeout=None):
        """
