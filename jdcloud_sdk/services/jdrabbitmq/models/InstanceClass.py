...
class InstanceClass(object):
    ...
    def __init__(self, role=None, nodeClassCode=None, nodeCpu=None, nodeMemoryGB=None, nodeCount=None, nodeDiskType=None, nodeDiskGB=None, instanceDiskGB=None):
        """
        ...
        :param instanceDiskGB: (Optional) kafka实例磁盘大小单位GB
        """
        ...
        self.instanceDiskGB = instanceDiskGB
