...
class K8sDispatchConfNewRequest(JDCloudRequest):
    """
    k8s日志采集配置下发
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(K8sDispatchConfNewRequest, self).__init__(
            '/k8sconfigNew', 'POST', header, version)
        self.parameters = parameters


class K8sDispatchConfNewParameters(object):
