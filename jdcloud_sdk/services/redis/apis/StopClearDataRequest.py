...
class StopClearDataRequest(JDCloudRequest):
    """
    停止数据清理任务
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(StopClearDataRequest, self).__init__(
            '/regions/{regionId}/cacheInstance/{cacheInstanceId}/stopClearData', 'POST', header, version)
        self.parameters = parameters


class StopClearDataParameters(object):
