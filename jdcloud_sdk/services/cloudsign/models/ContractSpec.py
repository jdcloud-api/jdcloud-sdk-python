...
class ContractSpec(object):
    ...
    def __init__(self, personStamps=None, companyStamps=None, contractContent=None, templateContent=None, templateId=None, contractTitle=None, caType=None, stampStyle=None, certExpire=None, businessId=None, needStorage=None, needContract=None):
        """
