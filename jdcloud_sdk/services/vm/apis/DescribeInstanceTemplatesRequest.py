...
- 单次查询最大可查询100条实例模板数据。
    ...
    def __init__(self, parameters, header=None, version="v1"):
        super(DescribeInstanceTemplatesRequest, self).__init__(
            '/regions/{regionId}/instanceTemplates', 'GET', header, version)
        self.parameters = parameters


class DescribeInstanceTemplatesParameters(object):
