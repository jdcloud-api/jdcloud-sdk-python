...
class FlavorConfig(object):
    ...
    def __init__(self, onSale=None, instanceClassCode=None, cpu=None, memoryGB=None, storageLimit=None, nodeCountLimit=None, resourceEstimates=None):
        """
        ...
        :param resourceEstimates: (Optional) 指定磁盘类型下的各种计算规格详情
        """
