...
class Probe(object):
    ...
    def __init__(self, initialDelaySeconds=None, periodSeconds=None, timeoutSeconds=None, failureThreshold=None, successThreshold=None, exec=None, httpGet=None, tcpSocket=None):
        """
        :param initialDelaySeconds: (Optional) 容器启动多长时\间后，触发探针。默认10秒；范围:[0-300]
        ...
        :param httpGet: (Optional) 对指定的端口和路径上的容器的 IP 地址执行 HTTP Get 请求。如果响应的状态码大于等于200 且小于 400，则诊断被认为是成功的。
