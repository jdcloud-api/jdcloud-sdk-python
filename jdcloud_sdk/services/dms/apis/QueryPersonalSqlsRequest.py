...
class QueryPersonalSqlsRequest(JDCloudRequest):
    """
    获取当前实例用户收藏sql
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(QueryPersonalSqlsRequest, self).__init__(
            '/regions/{regionId}/personalSql:query', 'POST', header, version)
        self.parameters = parameters


class QueryPersonalSqlsParameters(object):
