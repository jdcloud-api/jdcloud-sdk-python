...
class CustomRuleDetail(object):

    def __init__(self, calculation, metric, operation, period, threshold, times, calculateUnit=None, metricName=None, noticeLevel=None):
        """
        :param calculateUnit: (Optional) 指标的计算单位，比如bit/s、%、k等
        :param calculation:  统计方法，必须与定义的metric一致，可选值列表：avg,sum,max,min
        :param metric:  监控项metric
