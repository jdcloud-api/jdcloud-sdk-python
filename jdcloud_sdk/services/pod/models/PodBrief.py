...
class PodBrief(object):

    def __init__(self, podId=None, name=None, description=None, az=None, hostname=None, ag=None, instanceType=None, restartPolicy=None, terminationGracePeriodSeconds=None, vpcId=None, subnetId=None, privateIpAddress=None, dnsConfig=None, logConfig=None, hostAliases=None, podStatus=None, primaryNetworkInterface=None, createTime=None):
        """
