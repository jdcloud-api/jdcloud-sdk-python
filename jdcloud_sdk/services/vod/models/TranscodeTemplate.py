...
class TranscodeTemplate(object):

    def __init__(self, coderateId=None, name=None, format=None, width=None, height=None, videoCodeRate=None, videoCodec=None, audioCodec=None, type=None, updateTime=None):
        """
