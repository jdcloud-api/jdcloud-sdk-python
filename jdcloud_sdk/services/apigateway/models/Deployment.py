...
class Deployment(object):
    ...
    def __init__(self, deploymentId=None, revision=None, path=None, environment=None, backendServiceType=None, backendUrl=None, description=None, createTime=None, jdsfName=None, jdsfRegistryName=None, jdsfId=None):
        """
        :param deploymentId: (Optional) 部署ID
        :param revision: (Optional) 发布的修订版本号
        :param path: (Optional) 路径
        :param environment: (Optional) 环境：test、preview、online
