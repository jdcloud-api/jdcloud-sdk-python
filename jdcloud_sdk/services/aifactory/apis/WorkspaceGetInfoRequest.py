...
class WorkspaceGetInfoRequest(JDCloudRequest):
    """
    获取工作空间基本信息
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(WorkspaceGetInfoRequest, self).__init__(
            '/regions/{regionId}/apps/{appName}/workspaceGetInfo', 'POST', header, version)
        self.parameters = parameters


class WorkspaceGetInfoParameters(object):
